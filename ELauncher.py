...
for i in range(1):
	...
	verify("sprites/jumpscare_caligo_manifestation.png","http://elucidatewebstorage.unaux.com/wp-content/uploads/2026/05/jumpscare_caligo_manifestation.png");_g_done_assets += 1
			...
			if event.type == pygame.MOUSEBUTTONDOWN:
				...
				while loop:
					...
					if log1.collidepoint(mouse_x, mouse_y):
						...
						for event in events:
							if event.type == pygame.MOUSEBUTTONDOWN:
								zip_download("https://drive.google.com/uc?id=1LOIm5r4O4NzME7yustY2WEsPiats7QqC")
