...
def elucidate():
	...
	_preloaded_images = {
		...
		"elucidate_mercenary_sprite_idle_1": _load("sprites/player_mercenary/elucidate_mercenary_sprite_idle_up.png", True),
		"elucidate_mercenary_sprite_idle_2": _load("sprites/player_mercenary/elucidate_mercenary_sprite_idle_down.png", True),
		"elucidate_mercenary_sprite_idle_3": _load("sprites/player_mercenary/elucidate_mercenary_sprite_idle_left.png", True),
		"elucidate_mercenary_sprite_idle_4": _load("sprites/player_mercenary/elucidate_mercenary_sprite_idle_right.png", True),
		"elucidate_mercenary_sprite_walk_1_1": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_up_001.png",
													 True),
		"elucidate_mercenary_sprite_walk_1_2": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_up_002.png",
													 True),
		"elucidate_mercenary_sprite_walk_2_1": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_down_001.png",
													 True),
		"elucidate_mercenary_sprite_walk_2_2": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_down_002.png",
													 True),
		"elucidate_mercenary_sprite_walk_3_1": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_left_001.png",
													 True),
		"elucidate_mercenary_sprite_walk_3_2": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_left_002.png",
													 True),
		"elucidate_mercenary_sprite_walk_4_1": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_right_001.png",
													 True),
		"elucidate_mercenary_sprite_walk_4_2": _load("sprites/player_mercenary/elucidate_sprite_mercenary_move_right_002.png",
													 True),
	...
	SPRITES = {
		...
		"mercenary": {
			...
			"walk": {
				...
				"right": [_scaled_images["elucidate_mercenary_sprite_walk_4_1"],
						  _scaled_images["elucidate_mercenary_sprite_walk_4_2"]],
			},
			"attack": {
		...
		"cultist": {
			"idle": {
				"up": _scaled_images["idle_cultist_up"],
				"down": _scaled_images["idle_cultist_down"],
				"left": _scaled_images["idle_cultist_left"],
				"right": _scaled_images["idle_cultist_right"],
			},
			"walk": {
				"up": [_scaled_images["walk_cultist_up_001"],
					   _scaled_images["walk_cultist_up_002"]],
				"down": [_scaled_images["walk_cultist_down_001"],
						 _scaled_images["walk_cultist_down_002"]],
				"left": [_scaled_images["walk_cultist_left_001"],
						 _scaled_images["walk_cultist_left_002"]],
				"right": [_scaled_images["walk_cultist_right_001"],
						  _scaled_images["walk_cultist_right_002"]],
			},
			"attack": {
		...
		"priest": {
			"idle": {
				"up": _scaled_images["idle_priest_up"],
				"down": _scaled_images["idle_priest_down"],
				"left": _scaled_images["idle_priest_left"],
				"right": _scaled_images["idle_priest_right"],
			},
			"walk": {
				"up": [_scaled_images["walk_priest_up_001"], _scaled_images["walk_priest_up_002"]],
				...
				"right": [_scaled_images["walk_priest_right_001"],
						  _scaled_images["walk_priest_right_002"]],
			},
			"attack": {
				"up": [_scaled_images["attack_priest_up_001"],
					   _scaled_images["attack_priest_up_002"]],
				"down": [_scaled_images["attack_priest_down_001"],
						 _scaled_images["attack_priest_down_002"]],
				"left": [_scaled_images["attack_priest_left_001"],
						 _scaled_images["attack_priest_left_002"]],
		...
		"merchant": {
			"idle": {
				"up": _scaled_images["idle_merchant_up"],
				"down": _scaled_images["idle_merchant_down"],
				"left": _scaled_images["idle_merchant_left"],
				"right": _scaled_images["idle_merchant_right"],
			},
			"walk": {
				"up": [_scaled_images["walk_merchant_up_001"],
					   _scaled_images["walk_merchant_up_002"]],
				...
				"right": [_scaled_images["walk_merchant_right_001"],
						  _scaled_images["walk_merchant_right_002"]],
			},
			"attack": {
				"up": [_scaled_images["attack_merchant_up_001"],
					   _scaled_images["attack_merchant_up_002"]],
				"down": [_scaled_images["attack_merchant_down_001"],
						 _scaled_images["attack_merchant_down_002"]],
				"left": [_scaled_images["attack_merchant_left_001"],
						 _scaled_images["attack_merchant_left_002"]],
		...
		"shaman": {
			"idle": {
				"up": _scaled_images["idle_shaman_up"],
				"down": _scaled_images["idle_shaman_down"],
				"left": _scaled_images["idle_shaman_left"],
				"right": _scaled_images["idle_shaman_right"],
			},
			"walk": {
				"up": [_scaled_images["walk_shaman_up_001"], _scaled_images["walk_shaman_up_002"]],
				...
				"right": [_scaled_images["walk_shaman_right_001"],
						  _scaled_images["walk_shaman_right_002"]],
			},
			"attack": {
				"up": [_scaled_images["attack_shaman_up_001"],
					   _scaled_images["attack_shaman_up_002"]],
				"down": [_scaled_images["attack_shaman_down_001"],
						 _scaled_images["attack_shaman_down_002"]],
				"left": [_scaled_images["attack_shaman_left_001"],
						 _scaled_images["attack_shaman_left_002"]],
				"right": [_scaled_images["attack_shaman_right_001"],
						  _scaled_images["attack_shaman_right_002"]],
			},
		},
	}
	...
	def sys_gen_loading(n):
		...
		static_text_raw_center("Welcome to Elucidate RPG", color=(0, 0, 0), position=(screen_x // 2, screen_y - 100), size=25)
	...
	back_playselect_col = pygame.Rect(460, 671, 200, 30)
	ok_playselect_col   = pygame.Rect(460, 631, 200, 30)
	...
	interact_rect = pygame.Rect(601, 60, 72, 72)
	...
	area_walls = {
		"empty_room_test": [
			pygame.Rect(0, 0, 6375, 60),
			pygame.Rect(0, screen_y - 60, 6375, 60),
			pygame.Rect(0, 0, 60, screen_y),
			pygame.Rect(screen_x - 60, 0, 60, 260),
			pygame.Rect(screen_x - 60, 450, 60, 260),
		],
		"empty_room_test_001": [
			pygame.Rect(0, 0, screen_x, 60),
			pygame.Rect(0, screen_y - 60, screen_x, 60),
			pygame.Rect(0, 0, 60, 260),
			pygame.Rect(0, 450, 60, 260),
			pygame.Rect(-60, 0, 60, screen_y),
			pygame.Rect(screen_x - 60, 0, 60, 260),
			pygame.Rect(screen_x - 60, 450, 60, 260),
	...
	while main_game_loop:
		...
		if state == "version_check":
			...
			static_text_raw_center("Alpha 1.0.83", color=(255, 255, 255), position=(screen_x // 2, (screen_y // 2) + 60), size=20)
			...
			static_text_raw_center(f"INTERACT : {pygame.key.name(controls['interact'])}", (255, 255, 255), (screen_x // 2, 400), 30)
			static_text_raw_center(f"INVENTORY : {pygame.key.name(controls['inventory'])}", (255, 255, 255), (screen_x // 2, 440), 30)
			static_text_raw_center("BACK", color=(255, 255, 255), position=(screen_x // 2, 650), size=30)
			if colide_back.collidepoint(mouse_x, mouse_y):
				screen.blit(_scaled_images["elucidate_select_exit"], ((screen_x // 2) - 100, 635))
				static_text_raw_center("BACK", color=(0, 0, 0), position=(screen_x // 2, 650), size=30)
			...
			for event in events:
				if event.type == pygame.MOUSEBUTTONDOWN:
					if pygame.Rect(gfx_fps_slider_x, gfx_fps_slider_y - 10, gfx_fps_slider_w, 20).collidepoint(event.pos):
						fps_slider_dragging = True
					if pygame.Rect(gfx_cpu_slider_x, gfx_cpu_slider_y - 10, gfx_cpu_slider_w, 20).collidepoint(event.pos):
						cpu_slider_dragging = True
					if pygame.Rect(gfx_ram_slider_x, gfx_ram_slider_y - 10, gfx_ram_slider_w, 20).collidepoint(event.pos):
			...
			screen.blit(_preloaded_images["elucidate_select_player_001"], (0, 0))
		...
		elif state == "play_select_mercenary":
			screen.blit(_preloaded_images["elucidate_select_player_002"], (0, 0))
			static_text_raw("BACK",      color=(255, 255, 255), position=(460, 670), size=30)
			static_text_raw("OK",        color=(255, 255, 255), position=(460, 630), size=30)
			static_text_raw("Mercenary", color=(255, 255, 255), position=(460, 5),   size=60)
			if back_playselect_col.collidepoint(mouse_x, mouse_y):
				screen.blit(_scaled_images["elucidate_select_home_1"], (460, 671))
				static_text_raw("BACK", color=(0, 0, 0), position=(480, 670), size=30)
				for event in events:
					if event.type == pygame.MOUSEBUTTONDOWN:
						state = "play_select"
			elif ok_playselect_col.collidepoint(mouse_x, mouse_y):
				screen.blit(_scaled_images["elucidate_select_home_1"], (460, 631))
				static_text_raw("OK", color=(0, 0, 0), position=(480, 630), size=30)
				for event in events:
					if event.type == pygame.MOUSEBUTTONDOWN:
						...
						world_x = p.x - screen_x // 2 + p.size // 2
						world_y = p.y - screen_y // 2 + p.size // 2
						state = "mercenary_play_intro_001"

		elif state == "mercenary_play_intro_001":
			static_text_raw_center("Insert lore text here for mercenary.", color=(255, 255, 255), position=(screen_x // 2, screen_y // 2), size=30)
			static_text_raw_center("[ click anywhere to continue ]",       color=(255, 255, 255), position=(screen_x // 2, 695),           size=15)
			for event in events:
				if event.type == pygame.MOUSEBUTTONDOWN:
					npcs = []
					entity_walls = []
					...
					world_x = p.x - screen_x // 2 + p.size // 2
					world_y = p.y - screen_y // 2 + p.size // 2
					state = "mercenary_play_intro_002"

		elif state == "mercenary_play_intro_002":
			screen.blit(_preloaded_images["elucidate_full_scale_test"], (-world_x, -world_y))
			walls = area_walls["empty_room_test"].copy()
			...
			p.draw(screen, world_x, world_y)
			keys = pygame.key.get_pressed()
			interact_draw_x = interact_rect.x - world_x
			interact_draw_y = interact_rect.y - world_y
			pygame.draw.rect(screen, (255, 255, 0), (interact_draw_x, interact_draw_y, interact_rect.w, interact_rect.h))
			...
			static_text_raw("BACK", color=(255, 255, 255), position=(460, 670), size=30)
			static_text_raw("OK",   color=(255, 255, 255), position=(460, 630), size=30)
			static_text_raw("NPC1", color=(255, 255, 255), position=(460, 5),   size=40)
			if back_playselect_col.collidepoint(mouse_x, mouse_y):
				screen.blit(_scaled_images["elucidate_select_home_1"], (460, 671))
				static_text_raw("BACK", color=(0, 0, 0), position=(480, 670), size=30)
				for event in events:
