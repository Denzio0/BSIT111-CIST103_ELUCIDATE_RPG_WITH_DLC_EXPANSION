...
from elucidate_devkit import *  # DEVKIT ITO FOR DEVSZ OF GROUP WOZZ ONLYY
...
def elucidate():
    ...
    ram_limit_gb = 7
    limit = ram_limit_gb * 1024 * 1024 * 1024 * 7
    ...
    screen.fill((0, 0, 0))
    # ── layout anchors (all relative to screen size for resolution scaling) ──
    _ui_cx = screen_x // 2  # horizontal centre
    _bar_w = int(screen_x * 0.50)  # bar width = 50% of screen
    _bar_x = _ui_cx - _bar_w // 2  # bar left edge (centred)
    _bar_h = max(10, int(screen_y * 0.016))  # bar height scales with screen
    # Footer cluster sits in the bottom 10% of the screen
    _footer_cy = int(screen_y * 0.92)  # centre of the footer zone
    _bar_y = _footer_cy - _bar_h - 28  # bar sits 28px above footer centre
    _status_y = _bar_y - 26  # status text 26px above bar top
    _footer_y = _bar_y + _bar_h + 18  # "alpha 1.0" label 18px below bar
    ...
    # ── LAYER ORDER: gradient first, then text on top, then bar ──
    # 1. Gradient strip — blitted first so text renders on top of it
    try:
        _sel_img2 = pygame.image.load("images/elucidate_select_full.png")
        _grad_h2 = max(22, int(screen_y * 0.036))
        _grad_y2 = _status_y - _grad_h2 // 2  # vertically centres over text
        _sel_res2 = pygame.transform.scale(_sel_img2, (_bar_w, _grad_h2))
        screen.blit(_sel_res2, (_bar_x, _grad_y2))
    except Exception:
        pass
    # 2. Status text — drawn AFTER gradient so it is visible on top
    _s_surf = _lf_status.render(_load_status_text, True, (47, 45, 43))
    ...
    # 4. Percentage — vertically centred with bar, right of it
    ...
    # 5. Footer — two lines, properly spaced
    _footer_line1 = "ELUCIDATE RPG  \u2014  \u00A9 2026  GROUP WOZ  |  FGC UNAUX"
    _footer_line2 = "ALL RIGHTS RESERVED  |  ALPHA 1.0"
    ...
    def _load_item(filename):
        return _load(f"items/{filename}", True)

    _preloaded_images = {
        "wiki_characters_page":        _load("wiki_images/wiki_elucidate_characterspage.png"),
	"wiki_developers_page":        _load("wiki_images/wiki_elucidate_developerspage.png"),
	"wiki_download_page":        _load("wiki_images/wiki_elucidate_downloadpage.png"),
	"wiki_environment_page_1":        _load("wiki_images/wiki_elucidate_environmentspage1.png"),
	"wiki_environment_page_2":        _load("wiki_images/wiki_elucidate_environmentspage2.png"),
	"wiki_fanart_page":        _load("wiki_images/wiki_elucidate_fanartspage.png"),
	"wiki_home_page":        _load("wiki_images/wiki_elucidate_homepage.png"),
	"wiki_items_page_1":        _load("wiki_images/wiki_elucidate_itemspage1.png"),
	"wiki_items_page_2":        _load("wiki_images/wiki_elucidate_itemspage2.png"),
	"wiki_lore_page":        _load("wiki_images/wiki_elucidate_lorepage.png"),
	"wiki_npcs_page_1":        _load("wiki_images/wiki_elucidate_npcspage1.png"),
	"wiki_npcs_page_2":        _load("wiki_images/wiki_elucidate_npcspage2.png"),
    "elucidate_title": _load("images/elucidate_title.png"),
            ...
            "sprites/player_mercenary/elucidate_mercenary_sprite_idle_up.png", True),
                         ...
                         "user_item_short_sword": _load("images/user_item_short_sword.png", True),
                         "user_item_cleaver": _load("images/user_item_cleaver.png", True),
                         "user_item_knife": _load("images/user_item_knife.png", True),
                         "user_item_ancient_paper": _load("images/user_item_ancient_paper.png", True),
                         "user_item_iron_mask": _load("images/user_item_iron_mask.png", True),
                         "user_item_dark_priests_robe": _load(
                             "images/user_item_dark_priests_robe.png", True),
                         "user_item_priests_robe": _load("images/user_item_priests_robe.png", True),
                         "user_item_plate_helmet": _load("images/user_item_plate_helmet.png", True),
                         "user_item_padded_cap": _load("images/user_item_padded_cap.png", True),
                         "user_item_iron_cuirass": _load("images/user_item_iron_cuirass.png", True),
                         "user_item_loincloth": _load("images/user_item_loincloth.png", True),
                         "user_item_red_scarf": _load("images/user_item_red_scarf.png", True),
                         "user_item_iron_helmet": _load("images/user_item_iron_helmet.png", True),
                         "user_item_guard_bascinet": _load("images/user_item_guard_bascinet.png", True),
                         "user_item_guard_coif": _load("images/user_item_guard_coif.png", True),
                         "user_item_chainmail_hood": _load("images/user_item_chainmail_hood.png", True),
                         "user_item_black_dress": _load("images/user_item_black_dress.png", True),
                         "user_item_trench_coat": _load("images/user_item_trench_coat.png", True),
                         "user_item_corsairs_saber": _load("images/user_item_corsairs_saber.png", True),
                         "user_item_cloth_hood": _load("images/user_item_cloth_hood.png", True),
                         "user_item_leather_coat": _load("images/user_item_leather_coat.png", True),
                         "user_item_leather_jvest": _load("images/user_item_leather_jvest.png", True),
                         "user_item_plated_mail": _load("images/user_item_plated_mail.png", True),
                         "user_item_scutum": _load("images/user_item_scutum.png", True),
                         "user_item_musket": _load("images/user_item_musket.png", True),
                         "user_item_spear": _load("images/user_item_spear.png", True),
                         "user_item_hard_leather_armor": _load(
                             "images/user_item_hard_leather_armor.png", True),
                         "user_item_iron_plate": _load("images/user_item_iron_plate.png", True),
                         "user_item_stiletto": _load("images/user_item_stiletto.png", True),
                         "user_item_arm_guard": _load("images/user_item_arm_guard.png", True),
                         "user_item_iron_axe": _load("images/user_item_iron_axe.png", True),
                         "user_item_short_bow": _load("images/user_item_short_bow.png", True),
                         "user_item_leather_scraps": _load("images/user_item_leather_scraps.png", True),
                         ...
                         "materials_skill_book_of_instincts": _load("images/materials_skill_book_of_instincts.png",
                                                                    True),
                         "user_item_swift_boots": _load("images/user_item_swift_boots.png", True),
                         "user_item_heavy_crossbow": _load("images/user_item_heavy_crossbow.png", True),
                         "user_item_longbow": _load("images/user_item_longbow.png", True),
                         "user_item_maul": _load("images/user_item_maul.png", True),
                         "user_item_claymore": _load("images/user_item_claymore.png", True),
                         "user_item_scimitar": _load("images/user_item_scimitar.png", True),
                         "user_item_improvised_shiv": _load("images/user_item_improvised_shiv.png", True),
                         "user_item_steel_hammer": _load("images/user_item_steel_hammer.png", True),
                         "user_item_black_dressed_doll": _load("images/user_item_black_dressed_doll.png", True),
                         "user_item_dirk": _load("images/user_item_dirk.png", True),
                         "user_item_wooden_plank": _load("images/user_item_wooden_plank.png", True),
                         "user_item_dagger": _load("images/user_item_dagger.png", True),
                         "user_item_silver_wire": _load("images/user_item_silver_wire.png", True),
                         "user_item_red_amulet": _load("images/user_item_red_amulet.png", True),
                         "user_item_blue_amulet": _load("images/armour_accessories_blue_amulet.png", True),
                         "user_item_stick": _load("images/user_item_stick.png", True),
                         "user_item_ring": _load("images/user_item_ring.png", True),
                         ...
                         "materials_skill_book_of_trade_iii": _load("images/materials_skill_book_of_trade_iii.png",
                                                                    True),
                         "user_item_red_gem": _load("materials_gem_red_gem.png", True),
                         "user_item_blue_gem": _load("images/materials_gem_blue_gem.png", True),
                         "user_item_ale": _load("images/user_item_ale.png", True),
                         "user_item_wine": _load("images/user_item_wine.png", True),
                         "user_item_rum": _load("images/user_item_rum.png", True),
                         "user_item_iron_ingot": _load("images/user_item_iron_ingot.png", True),
                         "user_item_raw_iron": _load("images/user_item_raw_iron.png", True),
                         "user_item_blue_herb-1": _load("images/user_item_blue_herb-1.png", True),
                         "user_item_green_herb": _load("images/user_item_green_herb.png", True),
                         "user_item_paper": _load("images/user_item_paper.png", True),
                         "user_item_antibiotics": _load("images/user_item_antibiotics.png", True),
                         "user_item_betadine": _load("images/user_item_betadine.png", True),
                         "user_item_red_vial": _load("images/user_item_red_vial.png", True),
                         "user_item_empty_vial": _load("images/user_item_empty_vial.png", True),
                         "user_item_longsword": _load("images/user_item_longsword.png", True),
                         "user_item_wooden_buckler": _load("images/user_item_wooden_buckler.png", True),
                         "user_item_cultist_dagger": _load("images/user_item_cultist_dagger.png", True),
                         "user_item_flintlock": _load("images/user_item_flintlock.png", True),
                         "user_item_makeshift_spear": _load("images/user_item_makeshift_spear.png", True),
                         "user_item_blunderbuss": _load("images/user_item_blunderbuss.png", True),
                         "user_item_shaman_dagger": _load("images/user_item_shaman_dagger.png", True),
                         "user_item_priest_staff": _load("images/user_item_priest_staff.png", True),
                         "user_item_cultist_crossbow": _load("images/user_item_cultist_crossbow.png",
                                                             True),
                         "user_item_bow_string": _load("images/user_item_bow_string.png", True),
                         "user_item_short_sword": _load_item("weapon_1handed_short_sword.png"),
                         "user_item_cleaver": _load_item("weapon_1handed_cleaver.png"),
                         "user_item_knife": _load_item("weapon_1handed_knife.png"),
                         "user_item_ancient_paper": _load_item("materials_sheet_ancient_paper.png"),
                         "user_item_iron_mask": _load_item("armour_headware_iron_mask.png"),
                         "user_item_dark_priests_robe": _load_item("armour_body_armour_dark_priests_robe.png"),
                         "user_item_priests_robe": _load_item("armour_body_armour_priests_robe.png"),
                         "user_item_plate_helmet": _load_item("armour_headware_plate_helmet.png"),
                         "user_item_padded_cap": _load_item("armour_headware_padded_cap.png"),
                         "user_item_iron_cuirass": _load_item("armour_body_armour_iron_cuirass.png"),
                         "user_item_loincloth": _load_item("armour_body_armour_loincloth.png"),
                         "user_item_red_scarf": _load_item("armour_accessories_red_scarf.png"),
                         "user_item_iron_helmet": _load_item("armour_headware_iron_helmet.png"),
                         "user_item_guard_bascinet": _load_item("armour_headware_guard_bascinet.png"),
                         "user_item_guard_coif": _load_item("armour_headware_guard_coif.png"),
                         "user_item_chainmail_hood": _load_item("armour_headware_chainmail_hood.png"),
                         "user_item_black_dress": _load_item("armour_body_armour_black_dress.png"),
                         "user_item_trench_coat": _load_item("armour_body_armour_trench_coat.png"),
                         "user_item_corsairs_saber": _load_item("weapon_1handed_corsairs_saber.png"),
                         "user_item_cloth_hood": _load_item("weapon_1handed_cloth_hood.png"),
                         "user_item_leather_coat": _load_item("armour_body_armour_leather_coat.png"),
                         "user_item_leather_vest": _load_item("armour_body_armour_leather_vest.png"),
                         "user_item_scutum": _load_item("armour_shield_scutum.png"),
                         "user_item_plated_mail": _load_item("armour_body_armour_plated_mail.png"),
                         "user_item_shield_scutum": _load_item("armour_shield_scutum.png"),
                         "user_item_musket": _load_item("weapon_longrange_musket.png"),
                         "user_item_spear": _load_item("weapon_2handed_spear.png"),
                         "user_item_hard_leather_armor": _load_item("armour_body_armour_hard_leather_armor.png"),
                         "user_item_iron_plate": _load_item("armour_body_armour_iron_plate.png"),
                         "user_item_stiletto": _load_item("weapon_1handed_stiletto.png"),
                         "user_item_arm_guard": _load_item("armour_armwear_arm_guard.png"),
                         "user_item_iron_axe": _load_item("weapon_1handed_iron_axe.png"),
                         "user_item_short_bow": _load_item("weapon_longrange_short_bow.png"),
                         "user_item_leather_scraps": _load_item("materials_scrap_leather_scraps.png"),
                         "user_item_book_of_rapid_fire": _load_item("materials_skill_book_of_rapid_fire.png"),
                         "user_item_book_of_instincts": _load_item("materials_skill_book_of_instincts.png"),
                         "user_item_swift_boots": _load_item("armour_accessories_swift_boots.png"),
                         "user_item_heavy_crossbow": _load_item("weapon_longrange_heavy_crossbow.png"),
                         "user_item_longbow": _load_item("weapon_longrange_longbow.png"),
                         "user_item_maul": _load_item("weapon_2handed_maul.png"),
                         "user_item_claymore": _load_item("weapon_2handed_claymore.png"),
                         "user_item_scimitar": _load_item("weapon_1handed_scimitar.png"),
                         "user_item_improvised_shiv": _load_item("weapon_1handed_improvised_shiv.png"),
                         "user_item_steel_hammer": _load_item("weapon_1handed_steel_hammer.png"),
                         "user_item_black_dressed_doll": _load_item("material_toy_black_dressed_doll.png"),
                         "user_item_dirk": _load_item("weapon_1handed_dirk.png"),
                         "user_item_wooden_plank": _load_item("materials_plank_wooden_plank.png"),
                         "user_item_dagger": _load_item("weapon_1handed_dagger.png"),
                         "user_item_silver_wire": _load_item("materials_component_silver_wire.png"),
                         "user_item_red_amulet": _load_item("armour_accessories_red_amulet.png"),
                         "user_item_blue_amulet": _load_item("armour_accessories_blue_amulet.png"),
                         "user_item_stick": _load_item("materials_component_stick.png"),
                         "user_item_ring": _load_item("armour_accessories_ring.png"),
                         "user_item_book_of_marksmanship": _load_item("materials_skill_book_of_marksmanship.png"),
                         "user_item_book_of_stars": _load_item("materials_skill_book_of_stars.png"),
                         "user_item_book_of_crafsmanship": _load_item("materials_skill_book_of_crafsmanship.png"),
                         "user_item_book_of_agility": _load_item("materials_skill_book_of_agility.png"),
                         "user_item_book_of_healing": _load_item("materials_skill_book_of_healing.png"),
                         "user_item_book_of_the_secrets": _load_item("materials_skill_book_of_the_secrets.png"),
                         "user_item_book_of_enlightenment": _load_item("materials_save_book_of_enlightenment.png"),
                         "user_item_book_of_cowardice_i": _load_item("materials_skill_book_of_cowardice_i.png"),
                         "user_item_book_of_cowardice_ii": _load_item("materials_skill_book_of_cowardice_ii.png"),
                         "user_item_book_of_pestilence_i": _load_item("materials_skill_book_of_pestilence_i.png"),
                         "user_item_book_of_pestilence_ii": _load_item("materials_skill_book_of_pestilence_ii.png"),
                         "user_item_book_of_pestilence_iii": _load_item("materials_skill_book_of_pestilence_iii.png"),
                         "user_item_book_of_pestilence_iv": _load_item("materials_skill_book_of_pestilence_iv.png"),
                         "user_item_book_of_pestilence_v": _load_item("materials_skill_book_of_pestilence_v.png"),
                         "user_item_book_of_pestilence_vi": _load_item("materials_skill_book_of_pestilence_vi.png"),
                         "user_item_book_of_pestilence_vii": _load_item("materials_skill_book_of_pestilence_vii.png"),
                         "user_item_book_of_pestilence_viii": _load_item("materials_skill_book_of_pestilence_viii.png"),
                         "user_item_book_of_trade_i": _load_item("materials_skill_book_of_trade_i.png"),
                         "user_item_book_of_trade_ii": _load_item("materials_skill_book_of_trade_ii.png"),
                         "user_item_book_of_trade_iii": _load_item("materials_skill_book_of_trade_iii.png"),
                         "user_item_red_gem": _load_item("materials_gem_red_gem.png"),
                         "user_item_blue_gem": _load_item("materials_gem_blue_gem.png"),
                         "user_item_ale": _load_item("materials_beverage_ale.png"),
                         "user_item_wine": _load_item("materials_beverage_wine.png"),
                         "user_item_rum": _load_item("materials_beverage_rum.png"),
                         "user_item_iron_ingot": _load_item("materials_bar_iron_ingot.png"),
                         "user_item_raw_iron": _load_item("materials_ore_raw_iron.png"),
                         "user_item_blue_herb": _load_item("materials_foliage_blue_herb-1.png"),
                         "user_item_green_herb": _load_item("materials_foliage_green_herb.png"),
                         "user_item_paper": _load_item("materials_sheet_paper.png"),
                         "user_item_antibiotics": _load_item("materials_potion_antibiotics.png"),
                         "user_item_betadine": _load_item("materials_potion_betadine.png"),
                         "user_item_red_vial": _load_item("materials_potion_red_vial.png"),
                         "user_item_empty_vial": _load_item("materials_container_empty_vial.png"),
                         "user_item_longsword": _load_item("weapon_2handed_longsword.png"),
                         "user_item_greatsword": _load_item("weapon_2handed_claymore.png"),
                         "user_item_wooden_buckler": _load_item("armour_shield_wooden_buckler.png"),
                         "user_item_cultist_dagger": _load_item("weapon_1handed_cultist_dagger.png"),
                         "user_item_flintlock": _load_item("weapon_longrange_flintlock.png"),
                         "user_item_makeshift_spear": _load_item("weapon_2handed_makeshift_spear.png"),
                         "user_item_blunderbuss": _load_item("weapon_longrange_blunderbuss.png"),
                         "user_item_shaman_dagger": _load_item("weapon_1handed_shaman_dagger.png"),
                         "user_item_priest_staff": _load_item("weapon_2handed_priest_staff.png"),
                         "user_item_cultist_crossbow": _load_item("weapon_longrange_cultist_crossbow.png"),
                         "user_item_bow_string": _load_item("materials_component_bow_string.png"),
    ...
    _scaled_images = {"l_o_outer_gate_district": _sc(_preloaded_images["l_o_outer_gate_district"],
            ...
            _preloaded_images["elucidate_mercenary_sprite_walk_1_1"], (72, 72)),
                      ...
                      "user_item_short_sword": _sc(_preloaded_images["user_item_short_sword"], (48, 48)),
                      "user_item_cleaver": _sc(_preloaded_images["user_item_cleaver"], (48, 48)),
                      "user_item_knife": _sc(_preloaded_images["user_item_knife"], (48, 48)),
                      "user_item_ancient_paper": _sc(_preloaded_images["user_item_ancient_paper"],
                                                     (38, 38)),
                      "user_item_iron_mask": _sc(_preloaded_images["user_item_iron_mask"], (48, 48)),
                      "user_item_dark_priests_robe": _sc(
                          _preloaded_images["user_item_dark_priests_robe"], (48, 48)),
                      "user_item_priests_robe": _sc(_preloaded_images["user_item_priests_robe"],
                                                    (48, 48)),
                      "user_item_plate_helmet": _sc(_preloaded_images["user_item_plate_helmet"], (48, 48)),
                      "user_item_padded_cap": _sc(_preloaded_images["user_item_padded_cap"], (48, 48)),
                      "user_item_iron_cuirass": _sc(_preloaded_images["user_item_iron_cuirass"],
                                                    (48, 48)),
                      "user_item_loincloth": _sc(_preloaded_images["user_item_loincloth"], (48, 48)),
                      "user_item_red_scarf": _sc(_preloaded_images["user_item_red_scarf"], (48, 48)),
                      "user_item_iron_helmet": _sc(_preloaded_images["user_item_iron_helmet"], (48, 48)),
                      "user_item_guard_bascinet": _sc(_preloaded_images["user_item_guard_bascinet"],
                                                      (48, 48)),
                      "user_item_guard_coif": _sc(_preloaded_images["user_item_guard_coif"], (48, 48)),
                      "user_item_chainmail_hood": _sc(_preloaded_images["user_item_chainmail_hood"],
                                                      (48, 48)),
                      "user_item_black_dress": _sc(_preloaded_images["user_item_black_dress"],
                                                   (48, 48)),
                      "user_item_trench_coat": _sc(_preloaded_images["user_item_trench_coat"],
                                                   (48, 48)),
                      "user_item_corsairs_saber": _sc(_preloaded_images["user_item_corsairs_saber"],
                                                      (48, 48)),
                      "user_item_cloth_hood": _sc(_preloaded_images["user_item_cloth_hood"], (48, 48)),
                      "user_item_leather_coat": _sc(_preloaded_images["user_item_leather_coat"],
                                                    (48, 48)),
                      "user_item_leather_vest": _sc(_preloaded_images["user_item_leather_vest"], (48, 48)),
                      "user_item_leather_jvest": _sc(_preloaded_images["user_item_leather_jvest"],
                                                     (48, 48)),
                      "user_item_plated_mail": _sc(_preloaded_images["user_item_plated_mail"],
                                                   (48, 48)),
                      "user_item_scutum": _sc(_preloaded_images["user_item_scutum"], (48, 48)),
                      "user_item_musket": _sc(_preloaded_images["user_item_musket"], (48, 48)),
                      "user_item_spear": _sc(_preloaded_images["user_item_spear"], (48, 48)),
                      "user_item_hard_leather_armor": _sc(
                          _preloaded_images["user_item_hard_leather_armor"], (48, 48)),
                      "user_item_iron_plate": _sc(_preloaded_images["user_item_iron_plate"],
                                                  (48, 48)),
                      "user_item_stiletto": _sc(_preloaded_images["user_item_stiletto"], (48, 48)),
                      "user_item_arm_guard": _sc(_preloaded_images["user_item_arm_guard"], (48, 48)),
                      "user_item_iron_axe": _sc(_preloaded_images["user_item_iron_axe"], (48, 48)),
                      "user_item_short_bow": _sc(_preloaded_images["user_item_short_bow"], (48, 48)),
                      "user_item_leather_scraps": _sc(_preloaded_images["user_item_leather_scraps"],
                                                      (48, 48)),
                      ...
                      "materials_skill_book_of_instincts": _sc(_preloaded_images["user_item_book_of_instincts"],
                                                               (72, 72)),
                      "user_item_swift_boots": _sc(_preloaded_images["user_item_swift_boots"],
                                                   (48, 48)),
                      "user_item_heavy_crossbow": _sc(_preloaded_images["user_item_heavy_crossbow"],
                                                      (48, 48)),
                      "user_item_longbow": _sc(_preloaded_images["user_item_longbow"], (48, 48)),
                      "user_item_maul": _sc(_preloaded_images["user_item_maul"], (48, 48)),
                      "user_item_claymore": _sc(_preloaded_images["user_item_claymore"], (48, 48)),
                      "user_item_greatsword": _sc(_preloaded_images["user_item_greatsword"], (48, 48)),
                      "user_item_scimitar": _sc(_preloaded_images["user_item_scimitar"], (48, 48)),
                      "user_item_improvised_shiv": _sc(_preloaded_images["user_item_improvised_shiv"],
                                                       (48, 48)),
                      "user_item_steel_hammer": _sc(_preloaded_images["user_item_steel_hammer"], (48, 48)),
                      "user_item_black_dressed_doll": _sc(_preloaded_images["user_item_black_dressed_doll"],
                                                          (48, 48)),
                      "user_item_dirk": _sc(_preloaded_images["user_item_dirk"], (48, 48)),
                      "user_item_wooden_plank": _sc(_preloaded_images["user_item_wooden_plank"], (48, 48)),
                      "user_item_dagger": _sc(_preloaded_images["user_item_dagger"], (48, 48)),
                      "user_item_silver_wire": _sc(_preloaded_images["user_item_silver_wire"],
                                                   (48, 48)),
                      "user_item_red_amulet": _sc(_preloaded_images["user_item_red_amulet"],
                                                  (48, 48)),
                      "user_item_blue_amulet": _sc(_preloaded_images["user_item_blue_amulet"],
                                                   (48, 48)),
                      "user_item_stick": _sc(_preloaded_images["user_item_stick"], (48, 48)),
                      "user_item_ring": _sc(_preloaded_images["user_item_ring"], (48, 48)),
                      ...
                      "materials_skill_book_of_stars": _sc(_preloaded_images["user_item_book_of_stars"],
                                                           (72, 72)),
                      "materials_skill_book_of_crafsmanship": _sc(_preloaded_images["user_item_book_of_crafsmanship"],
                                                                  (72, 72)),
                      ...
                      "materials_skill_book_of_the_secrets": _sc(_preloaded_images["user_item_book_of_the_secrets"],
                                                                 (72, 72)),
                      "materials_save_book_of_enlightenment": _sc(_preloaded_images["user_item_book_of_enlightenment"],
                                                                  (72, 72)),
                      "materials_skill_book_of_cowardice_i": _sc(_preloaded_images["user_item_book_of_cowardice_i"],
                                                                 (72, 72)),
                      "materials_skill_book_of_cowardice_ii": _sc(_preloaded_images["user_item_book_of_cowardice_ii"],
                                                                  (72, 72)),
                      "materials_skill_book_of_pestilence_i": _sc(_preloaded_images["user_item_book_of_pestilence_i"],
                                                                  (72, 72)),
                      "materials_skill_book_of_pestilence_ii": _sc(_preloaded_images["user_item_book_of_pestilence_ii"],
                                                                   (72, 72)),
                      "materials_skill_book_of_pestilence_iii": _sc(
                          _preloaded_images["user_item_book_of_pestilence_iii"], (72, 72)),
                      "materials_skill_book_of_pestilence_iv": _sc(_preloaded_images["user_item_book_of_pestilence_iv"],
                                                                   (72, 72)),
                      "materials_skill_book_of_pestilence_v": _sc(_preloaded_images["user_item_book_of_pestilence_v"],
                                                                  (72, 72)),
                      "materials_skill_book_of_pestilence_vi": _sc(_preloaded_images["user_item_book_of_pestilence_vi"],
                                                                   (72, 72)),
                      "materials_skill_book_of_pestilence_vii": _sc(
                          _preloaded_images["user_item_book_of_pestilence_vii"], (72, 72)),
                      "materials_skill_book_of_pestilence_viii": _sc(
                          _preloaded_images["user_item_book_of_pestilence_viii"], (72, 72)),
                      "materials_skill_book_of_trade_i": _sc(_preloaded_images["user_item_book_of_trade_i"], (72, 72)),
                      "materials_skill_book_of_trade_ii": _sc(_preloaded_images["user_item_book_of_trade_ii"],
                                                              (72, 72)),
                      "materials_skill_book_of_trade_iii": _sc(_preloaded_images["user_item_book_of_trade_iii"],
                                                               (72, 72)),
                      "user_item_red_gem": _sc(_preloaded_images["user_item_red_gem"], (48, 48)),
                      "user_item_blue_gem": _sc(_preloaded_images["user_item_blue_gem"], (48, 48)),
                      "user_item_ale": _sc(_preloaded_images["user_item_ale"], (48, 48)),
                      "user_item_wine": _sc(_preloaded_images["user_item_wine"], (48, 48)),
                      "user_item_rum": _sc(_preloaded_images["user_item_rum"], (48, 48)),
                      "user_item_iron_ingot": _sc(_preloaded_images["user_item_iron_ingot"], (48, 48)),
                      "user_item_raw_iron": _sc(_preloaded_images["user_item_raw_iron"], (48, 48)),
                      "user_item_blue_herb-1": _sc(_preloaded_images["user_item_blue_herb"], (48, 48)),
                      "user_item_green_herb": _sc(_preloaded_images["user_item_green_herb"], (48, 48)),
                      "user_item_paper": _sc(_preloaded_images["user_item_paper"], (48, 48)),
                      "user_item_antibiotics": _sc(_preloaded_images["user_item_antibiotics"], (48, 48)),
                      "user_item_betadine": _sc(_preloaded_images["user_item_betadine"], (48, 48)),
                      "user_item_red_vial": _sc(_preloaded_images["user_item_red_vial"], (48, 48)),
                      "user_item_empty_vial": _sc(_preloaded_images["user_item_empty_vial"], (48, 48)),
                      "user_item_longsword": _sc(_preloaded_images["user_item_longsword"], (72, 72)),
                      "user_item_greatsword": _sc(_preloaded_images["user_item_greatsword"], (72, 72)),
                      "user_item_wooden_buckler": _sc(_preloaded_images["user_item_wooden_buckler"], (72, 72)),
                      "user_item_cultist_dagger": _sc(_preloaded_images["user_item_cultist_dagger"],
                                                      (72, 72)),
                      "user_item_flintlock": _sc(_preloaded_images["user_item_flintlock"], (72, 72)),
                      "user_item_makeshift_spear": _sc(_preloaded_images["user_item_makeshift_spear"],
                                                       (72, 72)),
                      "user_item_blunderbuss": _sc(_preloaded_images["user_item_blunderbuss"], (72, 72)),
                      "user_item_shaman_dagger": _sc(_preloaded_images["user_item_shaman_dagger"], (72, 72)),
                      "user_item_priest_staff": _sc(_preloaded_images["user_item_priest_staff"], (72, 72)),
                      "user_item_cultist_crossbow": _sc(_preloaded_images["user_item_cultist_crossbow"],
                                                        (72, 72)),
                      "user_item_bow_string": _sc(_preloaded_images["user_item_bow_string"],
                                                  (72, 72)),
            ...
            _preloaded_images["idle_caligo_manifestation_npc_down"], (72, 192)),
                      ...
                      "l_i_merchant_guild_hall": _sc(_preloaded_images["l_i_merchant_guild_hall"],
                                                     (int(5997 / 3.7), int(3350 / 3.7))), 
                       "e_elucidate_mercenary_sprite_idle_2": _sc(_preloaded_images["elucidate_mercenary_sprite_idle_2"],
                                                               (288, 288)),
                                                               }
    ...
    _ELUCIDATE_LOADING_TIPS = [
        "Preparing Character Profiles...",
        "Verifying World Data...",
        "Restoring Civilization Layers...",
        "Loading Combat Interfaces...",
        "Calibrating Environmental Lighting...",
        "Reconstructing Faction Territories...",
        "Indexing Dialogue Archives...",
        "Mapping Subterranean Passages...",
        "Loading Theocratic Records...",
        "Synchronizing Essential Files...",
        "Assembling NPC Behavioral Trees...",
        "Rendering District Geometry...",
        "Initializing Lumen Church Archives...",
        "Recompiling World State Variables...",
        "Restoring Orphanage Instance Data...",
        "Validating Player Progression Files...",
        "Loading Cultist Encounter Sequences...",
        "Establishing Harbor District Boundaries...",
        "Preparing Narrative Trigger Systems...",
        "Finalizing World Initialization...",
    ]
    ...
    class Player:
        ...
        def move(self, walls):
            ...
            # Step 1: Move X, test against ALL walls, resolve each hit
            new_x = self.x + self.dx
            test_rect = pygame.Rect(int(new_x), int(self.y), self.size, self.size)
            for wall in walls:
                if test_rect.colliderect(wall):
                    if self.dx > 0:
                        new_x = float(wall.left - self.size)
                    elif self.dx < 0:
                        new_x = float(wall.right)
                    # Update test_rect after each correction so multi-wall
                    # situations resolve cleanly without clipping
                    test_rect.x = int(new_x)
            self.x = new_x

            # Step 2: Move Y using the already-resolved X position
            new_y = self.y + self.dy
            test_rect = pygame.Rect(int(self.x), int(new_y), self.size, self.size)
            for wall in walls:
                if test_rect.colliderect(wall):
                    if self.dy > 0:
                        new_y = float(wall.top - self.size)
                    elif self.dy < 0:
                        new_y = float(wall.bottom)
                    test_rect.y = int(new_y)
            self.y = new_y

        def border(self):
            # CLAMP — hard stop at world edges, no wrap-around teleport
            if self.x < 0:
                self.x = 0.0
            if self.x > self.pw - self.size:
                self.x = float(self.pw - self.size)
            if self.y < 0:
                self.y = 0.0
            if self.y > self.ph - self.size:
                self.y = float(self.ph - self.size)
        ...
        def draw(self, screen, world_x, world_y):
            ...
            if self.state == "idle":
                ...
                sprite = sprite_set["idle"][self.facing]
            draw_x = int(self.x - world_x) - 16  # (72 - 40) // 2
            draw_y = int(self.y - world_y) - 16
    ...
    class NPC:
        def __init__(self, allowed_states, state, x, y, pw, ph, sprite_key):
            ...
            self.moving = False
            self.follow_distance = 90
            self.teleport_distance = 500
            self.companion_speed = 2
            ...
            if self.state == "hostile":
                ...
                if "roaming" in self.allowed_states:
                    ...
                    if self.move_timer <= 0:
                        ...
                        self.move_timer = random.randint(10, 120)
                    self.move_direction(walls, entities, player)
            elif self.state == "companion":
                if "companion" in self.allowed_states:
                    self.companion_follow(player, walls, entities)
            self.animate()
        ...
        def animate(self):
            ...
            if self.anim_timer >= 0.12:
                self.anim_timer = 0
                self.frame = (self.frame + 1) % 1024  # prevent unbounded growth
        ...
        def try_move(self, dx, dy, walls, entities, player):
            # ── AXIS-SEPARATED NPC COLLISION ───────────────────────────
            moved = False

            # Step 1: Attempt X movement
            if dx != 0:
                new_x = self.x + dx
                test_rect = pygame.Rect(int(new_x), int(self.y), 72, 72)
                x_blocked = False
                for w in walls:
                    if test_rect.colliderect(w):
                        x_blocked = True
                        break
                if not x_blocked and self.state != "hostile":
                    for e in entities:
                        if e is not self and test_rect.colliderect(e.get_rect()):
                            x_blocked = True
                            break
                    if not x_blocked and test_rect.colliderect(player.get_rect()):
                        x_blocked = True
                if not x_blocked:
                    self.x = new_x
                    moved = True

            # Step 2: Attempt Y movement (independent of X result)
            if dy != 0:
                new_y = self.y + dy
                test_rect = pygame.Rect(int(self.x), int(new_y), 72, 72)
                y_blocked = False
                for w in walls:
                    if test_rect.colliderect(w):
                        y_blocked = True
                        break
                if not y_blocked and self.state != "hostile":
                    for e in entities:
                        if e is not self and test_rect.colliderect(e.get_rect()):
                            y_blocked = True
                            break
                    if not y_blocked and test_rect.colliderect(player.get_rect()):
                        y_blocked = True
                if not y_blocked:
                    self.y = new_y
                    moved = True
        ...
        def companion_follow(self, player, walls, entities):
            """
            Companion follow logic — movement/support only.
            NO attack, NO hostile targeting, NO combat.
            Combat integration point is left to the other developer.
            """
            dx = player.x - self.x
            dy = player.y - self.y
            dist = (dx ** 2 + dy ** 2) ** 0.5

            # ── TELEPORT if too far (e.g. player ran off screen) ──
            ...
            self.speed = self.companion_speed

            if abs(dx) >= abs(dy):
                self.direction = "right" if dx > 0 else "left"
                move_x = self.speed if dx > 0 else -self.speed
                self.try_move(move_x, 0, walls, entities, player)
            else:
                self.direction = "down" if dy > 0 else "up"
                move_y = self.speed if dy > 0 else -self.speed
                self.try_move(0, move_y, walls, entities, player)

            self.speed = old_speed  # restore speed after move
    ...
    # dlc 5-character Layout: 1275px wide, 5 equal slots ~205px each, Cards centered per slot
    select_mercenary = pygame.Rect(30, 130, 210, 450)
    select_cultist = pygame.Rect(240, 130, 210, 450)
    select_priest = pygame.Rect(450, 130, 210, 450)
    select_shaman = pygame.Rect(665, 130, 210, 450)
    select_merchant = pygame.Rect(875, 130, 210, 450)

    back_playselect_col = pygame.Rect(680, 671, 200, 30)
    ok_playselect_col = pygame.Rect(680, 631, 200, 30)

    colide_inventory_stats = pygame.Rect(5, 18, 300, 35)
    colide_inventory_bag = pygame.Rect(5, 53, 300, 35)
    colide_inventory_equipment = pygame.Rect(5, 88, 300, 35)
    colide_inventory_continue = pygame.Rect(5, 123, 300, 35)
    colide_inventory_saves = pygame.Rect(5, 158, 300, 35)
    colide_inventory_exit = pygame.Rect(5, 193, 300, 35)
    ...
    p = None
    test_area_npc_idle = NPC(["hostile"], "hostile", 400, 300, 7000, 3500, "no")
    test_area_npc_idle1 = NPC(["idle"], "idle", 601, 60, 7000, 3500, "no")
    test_area_npc_idle2 = NPC(["roaming"], "roaming", 400, 300, 7000, 3500, "no")
    ...
    area_walls = {
        ...
        "map_02":
            [
                pygame.Rect(2210, 427, 23, 376),
                pygame.Rect(-42, 485, 42, 301),
        ...
        "map_03":
            [
                ...
                pygame.Rect(1669, 202, 150, 111),
                pygame.Rect(1715, 304, 137, 73),
                pygame.Rect(323, 1257, 38, 15),
                pygame.Rect(319, 1261, 43, 17),
                pygame.Rect(327, 1252, 27, 21),
                pygame.Rect(324, 1255, 9, 10),
                pygame.Rect(357, 1267, 5, 11),
                pygame.Rect(312, 1268, 11, 6),
                pygame.Rect(452, 1224, 8, 15),
                pygame.Rect(460, 1238, 12, 17),
                pygame.Rect(467, 1249, 6, 20),
                pygame.Rect(401, 1251, 9, 15),
                pygame.Rect(404, 1267, 13, 13),
                pygame.Rect(413, 1278, 11, 8),
                pygame.Rect(1786, 1183, 15, 67),
                pygame.Rect(1774, 1197, 11, 55),
                pygame.Rect(1763, 1211, 15, 45),
                pygame.Rect(1799, 1194, 8, 58),
                pygame.Rect(1807, 1202, 9, 56),
                pygame.Rect(259, 103, 23, 60),
                pygame.Rect(235, 101, 67, 12),
                pygame.Rect(236, 105, 21, 26),
                pygame.Rect(2531, 814, 74, 141),
                pygame.Rect(2467, 854, 61, 96),
                pygame.Rect(2435, 880, 34, 51),
                pygame.Rect(2067, 805, 106, 129),
                pygame.Rect(2215, 829, 81, 111),
                pygame.Rect(2300, 880, 37, 8),
                pygame.Rect(2294, 905, 34, 9),
                pygame.Rect(2025, 846, 42, 79),
                pygame.Rect(2078, 928, 34, 24),
                pygame.Rect(2110, 1302, 19, 61),
                pygame.Rect(2129, 1303, 38, 33),
                pygame.Rect(1937, 1305, 51, 19),
                pygame.Rect(1959, 1313, 26, 56),
                pygame.Rect(2125, 1230, 13, 65),
                pygame.Rect(2135, 1228, 9, 72),
                pygame.Rect(2142, 1238, 10, 60),
                pygame.Rect(2144, 1240, 30, 67),
                pygame.Rect(2157, 1246, 22, 210),
                pygame.Rect(704, 807, 125, 85),
                pygame.Rect(729, 700, 68, 42),
                pygame.Rect(913, 686, 81, 61),
                pygame.Rect(901, 698, 23, 41),
                pygame.Rect(1022, 858, 11, 126),
                pygame.Rect(1039, 861, 16, 125),
                pygame.Rect(999, 905, 35, 79),
                pygame.Rect(1066, 864, 21, 121),
                pygame.Rect(1116, 870, 41, 111),
                pygame.Rect(1088, 917, 33, 58),
                pygame.Rect(1102, 712, 82, 47),
                pygame.Rect(1170, 634, 43, 52),
                pygame.Rect(608, 931, 121, 71),
                pygame.Rect(507, 928, 105, 72),
                pygame.Rect(1000, 454, 52, 106),
                pygame.Rect(990, 486, 19, 81),
                pygame.Rect(1045, 479, 18, 80),
                pygame.Rect(610, 456, 57, 109),
                pygame.Rect(590, 497, 36, 74),
                pygame.Rect(602, 476, 11, 33),
                pygame.Rect(670, 492, 10, 76),
                pygame.Rect(663, 485, 13, 73),
                pygame.Rect(1933, 1432, 246, 26),
            ],
        "map_04":
            [
                pygame.Rect(-39, 390, 36, 119),
                ...
                pygame.Rect(421, 171, 107, 86),
                pygame.Rect(588, 173, 64, 65),
                pygame.Rect(575, 193, 28, 53),
                pygame.Rect(645, 184, 26, 57),
                pygame.Rect(266, 168, 74, 47),
                pygame.Rect(161, 101, 7, 104),
                pygame.Rect(149, 108, 11, 93),
                pygame.Rect(138, 125, 20, 92),
                pygame.Rect(53, 159, 96, 44),
                pygame.Rect(24, 185, 89, 58),
            ],
        "map_05":
            [
                pygame.Rect(737, 890, 268, 17),
                ...
                pygame.Rect(192, 104, 34, 55),
                pygame.Rect(262, 78, 17, 69),
                pygame.Rect(1567, 122, 8, 258),
            ],
        "map_06":
            [
                pygame.Rect(2349, 525, 41, 182),
                pygame.Rect(-45, 519, 45, 213),
                pygame.Rect(799, 1239, 769, 47),
                ...
                pygame.Rect(341, 380, 96, 37),
                pygame.Rect(607, 547, 64, 18),
                pygame.Rect(942, 376, 19, 97),
                pygame.Rect(1137, 264, 125, 69),
                pygame.Rect(1062, 299, 12, 73),
                pygame.Rect(1068, 294, 15, 63),
                pygame.Rect(1074, 277, 11, 71),
                pygame.Rect(951, 260, 130, 73),
                pygame.Rect(203, 312, 61, 63),
                pygame.Rect(312, 59, 28, 192),
            ],
        "map_07":
            [
                ...
                pygame.Rect(125, 708, 43, 46),
                pygame.Rect(135, 784, 40, 45),
                pygame.Rect(137, 875, 34, 63),
                pygame.Rect(2089, 171, 91, 75),
                pygame.Rect(2190, 707, 42, 51),
                pygame.Rect(2184, 783, 45, 46),
                pygame.Rect(2180, 842, 84, 62),
                pygame.Rect(1834, 1123, 205, 59),
                pygame.Rect(1740, 1126, 47, 59),
                pygame.Rect(1783, 1138, 51, 46),
            ],
        "map_08":
            [
        ...
        "map_09":
            [
                ...
                pygame.Rect(209, 430, 38, 101),
                pygame.Rect(236, 440, 41, 86),
                pygame.Rect(275, 476, 27, 45),
                pygame.Rect(328, 56, 23, 204),
            ],
        "map_10":
            [
                pygame.Rect(0, 0, 232, 622),
        ...
        "map_11":
            [
                pygame.Rect(2353, 512, 83, 267),
                pygame.Rect(99, -33, 388, 48),
                pygame.Rect(-38, 539, 38, 261),
                pygame.Rect(15, 1177, 489, 53),
        ...
        "map_14":
            [
                ...
                pygame.Rect(5, 522, 123, 146),
                pygame.Rect(-3, 672, 97, 159),
                pygame.Rect(1, 659, 127, 22),
                pygame.Rect(302, 497, 51, 133),
                pygame.Rect(194, 556, 104, 60),
                pygame.Rect(227, 629, 33, 87),
                pygame.Rect(218, 642, 10, 61),
                pygame.Rect(326, 770, 99, 69),
                pygame.Rect(260, 739, 51, 95),
                pygame.Rect(216, 814, 47, 22),
                pygame.Rect(356, 810, 778, 28),
                pygame.Rect(653, 146, 49, 36),
                pygame.Rect(1451, -9, 905, 362),
                pygame.Rect(-4, 833, 313, 39),
                pygame.Rect(1469, 359, 11, 173),
            ],
        "map_15":
            [
                pygame.Rect(485, -33, 483, 39),
                pygame.Rect(960, 938, 582, 45),
        ...
        "map_17":
            [
                pygame.Rect(1817, 143, 106, 438),
                pygame.Rect(361, -24, 236, 27),
                pygame.Rect(-19, 405, 17, 238),
                pygame.Rect(348, 1017, 284, 37),
        ...
        "map_18":
            [
                pygame.Rect(1671, 430, 9, 389),
                pygame.Rect(1148, -70, 537, 70),
                pygame.Rect(1816, 450, 14, 403),
                pygame.Rect(-38, 408, 39, 490),
        ...
        "map_19":
            [
                pygame.Rect(2, 783, 1676, 12),
                pygame.Rect(0, 783, 5, 5),
                pygame.Rect(1667, 717, 12, 71),
                pygame.Rect(1568, -5, 112, 680),
            ],
        "map_20":
            [
                pygame.Rect(743, 1015, 388, 43),
                pygame.Rect(-38, 741, 39, 194),
        ...
        "map_25":
            [
                ...
                pygame.Rect(119, 546, 36, 124),
                pygame.Rect(147, 546, 29, 136),
                pygame.Rect(173, 565, 47, 151),
                pygame.Rect(216, 588, 37, 156),
                pygame.Rect(249, 610, 32, 162),
                pygame.Rect(278, 619, 37, 170),
                pygame.Rect(657, 555, 85, 176),
                pygame.Rect(680, 536, 159, 229),
                pygame.Rect(695, 518, 146, 132),
                pygame.Rect(714, 502, 142, 97),
                pygame.Rect(727, 490, 187, 104),
                pygame.Rect(739, 472, 202, 25),
                pygame.Rect(745, 451, 195, 23),
                pygame.Rect(246, 365, 28, 60),
                pygame.Rect(256, 357, 43, 72),
                pygame.Rect(279, 348, 41, 83),
                pygame.Rect(313, 356, 18, 75),
                pygame.Rect(327, 366, 19, 56),
                pygame.Rect(390, 335, 36, 34),
                pygame.Rect(93, 237, 69, 47),
                pygame.Rect(158, 243, 24, 74),
                pygame.Rect(176, 253, 27, 75),
                pygame.Rect(199, 258, 19, 71),
                pygame.Rect(210, 260, 21, 77),
                pygame.Rect(220, 269, 22, 42),
                pygame.Rect(235, 273, 20, 23),
                pygame.Rect(112, 279, 56, 28),
                pygame.Rect(76, 367, 129, 63),
                pygame.Rect(143, 527, 83, 24),
                pygame.Rect(150, 499, 82, 41),
                pygame.Rect(163, 475, 45, 31),
                pygame.Rect(222, 509, 32, 76),
                pygame.Rect(250, 516, 19, 41),
                pygame.Rect(495, 422, 92, 32),
                pygame.Rect(510, 401, 24, 87),
                pygame.Rect(522, 383, 48, 115),
                pygame.Rect(552, 374, 48, 134),
                pygame.Rect(589, 372, 35, 127),
                pygame.Rect(611, 383, 34, 103),
                pygame.Rect(638, 403, 18, 68)
            ],
        "map_26":
            [
        ...
        "map_28":
            [
                pygame.Rect(2878, 171, 13, 1358),
                pygame.Rect(-27, 600, 28, 358),
        ...
        "map_30":
            [
                pygame.Rect(-5, 2, 13, 709),
                pygame.Rect(0, 703, 1272, 20),
                pygame.Rect(1266, 4, 16, 720),
                pygame.Rect(1021, 580, 169, 69),
                pygame.Rect(1076, 646, 52, 36),
                pygame.Rect(1077, 541, 47, 35),
                pygame.Rect(7, -1, 304, 83),
                pygame.Rect(14, 80, 228, 26),
                pygame.Rect(486, -1, 785, 83),
                pygame.Rect(553, 79, 242, 26),
                pygame.Rect(1016, 136, 194, 62),
                pygame.Rect(1091, 100, 57, 35),
                pygame.Rect(308, 254, 90, 420),
                pygame.Rect(95, 263, 92, 418),
                pygame.Rect(483, 204, 103, 338),
                pygame.Rect(491, 620, 52, 97),
                pygame.Rect(793, 649, 52, 71),
                pygame.Rect(625, 615, 95, 56),
                pygame.Rect(665, 661, 19, 46),
                pygame.Rect(477, 206, 366, 75),
                pygame.Rect(743, 213, 113, 341),
                pygame.Rect(848, 231, 58, 312),
                pygame.Rect(801, 539, 104, 28),
            ],
        "map_31":
            [
        ...
        "map_32":
            [
                pygame.Rect(1208, 1237, 1030, 7),
                pygame.Rect(167, 4, 135, 156),
                pygame.Rect(-3, -1, 350, 159),
                pygame.Rect(-3, 150, 122, 1089),
                pygame.Rect(101, 754, 70, 401),
                pygame.Rect(167, 838, 92, 405),
                pygame.Rect(101, 1148, 1420, 98),
                pygame.Rect(856, 1015, 204, 124),
                pygame.Rect(864, 996, 194, 23),
                pygame.Rect(925, 970, 70, 25),
                pygame.Rect(699, 862, 78, 129),
                pygame.Rect(682, 868, 18, 68),
                pygame.Rect(657, 911, 46, 32),
                pygame.Rect(660, 941, 51, 129),
                pygame.Rect(625, 967, 34, 80),
                pygame.Rect(231, 749, 164, 391),
                pygame.Rect(387, 962, 158, 182),
                pygame.Rect(537, 979, 52, 166),
                pygame.Rect(583, 1028, 58, 128),
                pygame.Rect(654, 1067, 101, 85),
                pygame.Rect(813, 1055, 47, 89),
                pygame.Rect(1054, 1055, 38, 83),
                pygame.Rect(1146, 1014, 179, 139),
                pygame.Rect(1184, 981, 98, 39),
                pygame.Rect(761, 784, 121, 124),
                pygame.Rect(835, 760, 26, 27),
                pygame.Rect(912, 750, 114, 169),
                pygame.Rect(863, 808, 63, 116),
                pygame.Rect(885, 793, 36, 14),
                pygame.Rect(1017, 844, 44, 46),
                pygame.Rect(995, 889, 49, 22),
                pygame.Rect(1173, 758, 116, 144),
                pygame.Rect(1144, 855, 55, 54),
                pygame.Rect(1234, 902, 58, 34),
                pygame.Rect(1304, 739, 20, 141),
                pygame.Rect(1315, 743, 44, 47),
                pygame.Rect(1288, 849, 28, 70),
                pygame.Rect(1305, 825, 56, 72),
                pygame.Rect(1364, 860, 102, 118),
                pygame.Rect(1303, 907, 87, 53),
                pygame.Rect(1397, 970, 71, 76),
                pygame.Rect(1465, 990, 46, 149),
                pygame.Rect(1427, 1054, 42, 82),
                pygame.Rect(1155, 728, 25, 63),
                pygame.Rect(216, 196, 99, 68),
                pygame.Rect(114, 447, 42, 161),
                pygame.Rect(188, 387, 206, 122),
                pygame.Rect(387, 465, 38, 148),
                pygame.Rect(184, 505, 55, 135),
                pygame.Rect(432, 567, 19, 143),
                pygame.Rect(452, 566, 33, 60),
                pygame.Rect(304, 265, 86, 36),
                pygame.Rect(115, 271, 75, 27),
                pygame.Rect(244, 292, 31, 37),
                pygame.Rect(301, 161, 77, 22),
                pygame.Rect(353, 33, 50, 42),
                pygame.Rect(632, -7, 17, 439),
                pygame.Rect(640, 424, 255, 91),
                pygame.Rect(605, 24, 30, 392),
                pygame.Rect(575, 299, 39, 62),
                pygame.Rect(879, 498, 146, 76),
                pygame.Rect(897, 578, 102, 33),
                pygame.Rect(847, 514, 39, 55),
                pygame.Rect(749, 504, 36, 49),
                pygame.Rect(792, 542, 55, 26),
                pygame.Rect(788, 498, 50, 40),
                pygame.Rect(713, -9, 744, 226),
                pygame.Rect(719, 209, 345, 127),
                pygame.Rect(1150, 212, 296, 129),
                pygame.Rect(1161, 332, 71, 50),
                pygame.Rect(969, 335, 72, 43),
                pygame.Rect(1438, 198, 6, 154),
                pygame.Rect(1436, 188, 72, 66),
                pygame.Rect(1499, 15, 733, 322),
                pygame.Rect(1495, 333, 17, 169),
                pygame.Rect(1327, 426, 183, 75),
                pygame.Rect(1357, 493, 113, 26),
                pygame.Rect(1180, 490, 155, 80),
                pygame.Rect(1241, 557, 36, 45),
                pygame.Rect(1622, 1222, 604, 19),
                pygame.Rect(2040, 771, 191, 50),
                pygame.Rect(2082, 861, 141, 358),
                pygame.Rect(2120, 828, 106, 34),
                pygame.Rect(2128, 816, 89, 16),
                pygame.Rect(1922, 920, 120, 91),
                pygame.Rect(1672, 918, 123, 96),
                pygame.Rect(1694, 1032, 80, 36),
                pygame.Rect(1931, 1035, 88, 39),
                pygame.Rect(1700, 762, 234, 83),
                pygame.Rect(1686, 350, 127, 112),
                pygame.Rect(1694, 328, 536, 27),
                pygame.Rect(1654, 433, 44, 104),
                pygame.Rect(1698, 434, 15, 212),
                pygame.Rect(1725, 607, 135, 67),
                pygame.Rect(1771, 588, 61, 18),
                pygame.Rect(1745, 530, 92, 31),
                pygame.Rect(1727, 461, 77, 20),
                pygame.Rect(1870, 363, 54, 100),
                pygame.Rect(1890, 355, 336, 159),
                pygame.Rect(1892, 494, 150, 92),
                pygame.Rect(1932, 581, 88, 44),
                pygame.Rect(2093, 513, 128, 10),
                pygame.Rect(2099, 523, 120, 82),
                pygame.Rect(2114, 604, 108, 27),
                pygame.Rect(2201, 600, 20, 175),
                pygame.Rect(2094, 656, 76, 89),
                pygame.Rect(2169, 671, 30, 78),
                pygame.Rect(1780, 730, 119, 24),
                pygame.Rect(2068, 681, 20, 74),
                pygame.Rect(696, 99, 32, 96),
                pygame.Rect(401, 799, 20, 137),
                pygame.Rect(423, 819, 24, 42),
                pygame.Rect(985, 910, 35, 19),
                pygame.Rect(1018, 907, 25, 14),
                pygame.Rect(1025, 731, 13, 115),
                pygame.Rect(1030, 731, 21, 47),
                pygame.Rect(1050, 747, 18, 34),
                pygame.Rect(1422, 555, 20, 20),
                pygame.Rect(1251, 329, 14, 71),
                pygame.Rect(942, 330, 10, 68),
                pygame.Rect(686, 209, 66, 50),
            ],
        "map_33":
            [
        ...
        "map_36":
            [
                pygame.Rect(1363, 548, 104, 131),
                pygame.Rect(1210, 670, 246, 13),
                pygame.Rect(1209, 550, 99, 120),
        ...
        "map_38":
            [
                pygame.Rect(2392, 1673, 279, 19),
                pygame.Rect(2999, 564, 25, 422),
                pygame.Rect(-8, 1417, 7, 304),
                pygame.Rect(-11, 1671, 452, 29),
        ...
        "map_39":
            [
                ...
                pygame.Rect(869, 47, 411, 313),
                pygame.Rect(1105, 313, 217, 378),
                pygame.Rect(366, 233, 50, 79),
                pygame.Rect(322, 283, 38, 42),
                pygame.Rect(622, 28, 51, 99),
                pygame.Rect(531, 103, 35, 38),
                pygame.Rect(547, 98, 37, 41),
                pygame.Rect(558, 84, 43, 43),
                pygame.Rect(681, 108, 31, 29),
                pygame.Rect(288, 123, 37, 65),
                pygame.Rect(170, 233, 62, 83),
                pygame.Rect(148, 108, 37, 71),
                pygame.Rect(204, 47, 32, 99),
                pygame.Rect(189, 79, 27, 68),
                pygame.Rect(238, 88, 35, 48),
                pygame.Rect(275, 640, 15, 99),
                pygame.Rect(285, 634, 18, 102),
                pygame.Rect(295, 630, 16, 108),
                pygame.Rect(302, 636, 22, 99),
                pygame.Rect(330, 714, 24, 36),
                pygame.Rect(332, 705, 40, 55),
                pygame.Rect(344, 695, 20, 37),
                pygame.Rect(369, 710, 21, 45),
                pygame.Rect(637, 786, 23, 117),
                pygame.Rect(626, 789, 20, 113),
                pygame.Rect(616, 821, 14, 72),
                pygame.Rect(655, 836, 19, 71),
                pygame.Rect(1247, 820, 21, 46),
                pygame.Rect(1232, 833, 29, 36),
                pygame.Rect(1260, 813, 32, 35),
                pygame.Rect(1345, 796, 23, 97),
                pygame.Rect(1326, 794, 33, 111),
                pygame.Rect(1316, 822, 24, 81),
                pygame.Rect(1302, 859, 23, 46),
                pygame.Rect(1300, 875, 21, 25),
                pygame.Rect(1398, 882, 34, 30),
                pygame.Rect(1571, 774, 18, 89),
                pygame.Rect(1554, 768, 27, 100),
                pygame.Rect(1541, 789, 32, 76),
                pygame.Rect(1524, 830, 25, 33),
                pygame.Rect(1612, 837, 27, 69),
                pygame.Rect(1598, 854, 30, 59),
                pygame.Rect(1589, 883, 11, 23),
                pygame.Rect(1659, 817, 12, 76),
                pygame.Rect(1645, 844, 20, 53),
                pygame.Rect(1628, 700, 11, 86),
                pygame.Rect(1617, 718, 21, 67),
                pygame.Rect(1316, 459, 136, 109),
                pygame.Rect(1321, 568, 86, 55),
                pygame.Rect(1411, 563, 26, 28),
                pygame.Rect(1318, 397, 40, 24),
                pygame.Rect(1323, 424, 48, 33),
                pygame.Rect(1361, 411, 36, 50),
                pygame.Rect(1399, 434, 22, 30),
                pygame.Rect(1360, 363, 35, 25),
                pygame.Rect(1389, 354, 16, 22),
                pygame.Rect(1402, 352, 21, 11),
                pygame.Rect(1412, 346, 33, 6),
                pygame.Rect(1402, 374, 26, 41),
                pygame.Rect(1419, 419, 10, 12),
                pygame.Rect(1583, 248, 32, 96),
                pygame.Rect(1566, 299, 28, 55),
                pygame.Rect(1607, 277, 15, 72),
                pygame.Rect(1646, 255, 32, 61),
                pygame.Rect(1641, 164, 18, 67),
                pygame.Rect(1651, 149, 28, 84),
                pygame.Rect(1658, 138, 10, 14),
                pygame.Rect(1416, 120, 42, 95),
                pygame.Rect(1406, 154, 19, 62),
                pygame.Rect(1505, 249, 37, 43),
                pygame.Rect(1470, 202, 33, 63),
                pygame.Rect(1555, 213, 41, 48),
                pygame.Rect(1515, 94, 24, 68),
                pygame.Rect(1474, 109, 17, 50),
                pygame.Rect(1606, 110, 10, 87)
            ],
        "map_44":
            [
                pygame.Rect(0, 0, 467, 177),
        ...
        "map_46":
            [
                pygame.Rect(0, 0, 1275, 50),
                pygame.Rect(0, 660, 1275, 50),
                pygame.Rect(0, 0, 50, 710),
                pygame.Rect(1225, 0, 50, 710),
            ],
        "map_47":
            [
                pygame.Rect(0, 0, 1275, 50),
    ...
    def _get_walls(map_key):
        """Safe wall lookup. Falls back to screen-border walls if key missing."""
        if map_key in area_walls:
            return area_walls[map_key].copy()
        return [
            pygame.Rect(0, 0, 1275, 50),
            pygame.Rect(0, 660, 1275, 50),
            pygame.Rect(0, 0, 50, 710),
    ...
    devkit = ElucidateDevKit(
        ...
        _dk_set_state,
        npc_sprites=SPRITES,
        NPC_class=NPC,  # the NPC class defined in main.py
        pyperclip=_pyperclip if _HAS_PYPERCLIP else None,
    )

    ambient("music/elucidate_calm.wav", -1)
    delta = 0.0  # ensure delta is defined before any draw call that closes over it
    ...
    while main_game_loop:
        ...
        _state_ref[0] = state  # keep devkit state ref in sync
        ...
        # ── NPC DEBUG TOOL: KEY EVENTS ───────────────────────────────
        for event in events:
            if event.type == pygame.QUIT:
                elucidate_sys_exit()

            # ── DEVKIT EVENTS ──────────────────────────────────────────────
            devkit.handle_hotkeys(
                event,
                p=p,
                inventory_dict={},  # swap for your live inventory dict
                npc_list=npcs,
                world_x=world_x,
                world_y=world_y,
                mouse_pos=(mouse_x, mouse_y),
            )
            devkit.handle_menu_click(event, p=p, inventory_dict={})
            devkit.handle_warp_draw(event, world_x, world_y, (mouse_x, mouse_y))
            # NOTE: Replace `{}` above with the inventory dict once you (ALWYN)
            #       have defined it (e.g. `inventory_items`).
        ...
        if state == "version_check":
            ...
            static_text_raw_center(f"FRAME RATE limit :  {fps_label}", ui_white, (screen_x // 2, 220), 30)
            ...
            static_text_raw_center(f"PROCESSOR THREADS :  {cpu_core_limit}", ui_white, (screen_x // 2, 340), 30)
            ...
            static_text_raw_center(f"MEMORY ALLOCATION :  {ram_limit_gb} GB", ui_white, (screen_x // 2, 460), 30)
            ...
            if wiki_page == 0:
                screen.blit(_preloaded_images["wiki_characters_page"], (wiki_x, wiki_y))
            if wiki_page == 1:(
                screen.blit(_preloaded_images["wiki_developers_page"], (wiki_x, wiki_y)))
            if wiki_page == 2:
                screen.blit(_preloaded_images["wiki_download_page"], (wiki_x, wiki_y))
            if wiki_page == 3:
                screen.blit(_preloaded_images["wiki_environment_page_1"], (wiki_x, wiki_y))
            if wiki_page == 4:
                screen.blit(_preloaded_images["wiki_environment_page_2"], (wiki_x, wiki_y))
            if wiki_page == 5:
                screen.blit(_preloaded_images["wiki_fanart_page"], (wiki_x, wiki_y))
            if wiki_page == 6:
                screen.blit(_preloaded_images["wiki_home_page"], (wiki_x, wiki_y))
            if wiki_page == 7:
                screen.blit(_preloaded_images["wiki_items_page_1"], (wiki_x, wiki_y))
            if wiki_page == 8:
                screen.blit(_preloaded_images["wiki_items_page_2"], (wiki_x, wiki_y))
            if wiki_page == 9:
                screen.blit(_preloaded_images["wiki_lore_page"], (wiki_x, wiki_y))
            if wiki_page == 10:
                screen.blit(_preloaded_images["wiki_npcs_page_1"], (wiki_x, wiki_y))
            if wiki_page == 11:
                screen.blit(_preloaded_images["wiki_npcs_page_2"], (wiki_x, wiki_y))
            ...
            if dlc == True:
                ...
                if select_mercenary.collidepoint(mouse_x, mouse_y):
                    _hovered_char = ("mercenary", "lucidus", "elucidate_dlc_user_selection_bg_002")
                if select_cultist.collidepoint(mouse_x, mouse_y):
                    _hovered_char = ("cultist", "funeris", "elucidate_dlc_user_selection_bg_003")
                if select_priest.collidepoint(mouse_x, mouse_y):
                    _hovered_char = ("priest", "father calum", "elucidate_dlc_user_selection_bg_004")
                if select_shaman.collidepoint(mouse_x, mouse_y):
                    _hovered_char = ("shaman", "pluvia", "elucidate_dlc_user_selection_bg_005")
                if select_merchant.collidepoint(mouse_x, mouse_y):
                    _hovered_char = ("merchant", "konrad", "elucidate_dlc_user_selection_bg_006")
                if _hovered_char:
                    screen.blit(_preloaded_images[_hovered_char[2]], (0, 0))
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            user_class = _hovered_char[0]
                            user_name = _hovered_char[1]
                            state = "play_select_1"
            else:
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_map02 = pygame.Rect(447, 541, 122, 16)
            if p.get_rect().colliderect(warp_map02):
                p.x = 921
                p.y = 548
                state = "map_02"
            keys = pygame.key.get_pressed()
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_map01 = pygame.Rect(907, 476, 89, 77)
            if p.get_rect().colliderect(warp_map01):
                p.x = 485
                p.y = 474
                state = "map_01"
            warp_to_theocratic_capital1 = pygame.Rect(0, 489, 25, 282)
            if p.get_rect().colliderect(warp_to_theocratic_capital1):
                p.x = 1153
                p.y = 1102
                state = "map_07"
            warp_map03 = pygame.Rect(2204, 440, 15, 356)
            if p.get_rect().colliderect(warp_map03):
                p = player(user_class, (screen_x / 2) - 36, (screen_y / 2) - 36, 6375, 3550)
                p.x = 350
                p.y = 30
                state = "map_03"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_map_02 = pygame.Rect(243, 0, 199, 8)
            if p.get_rect().colliderect(warp_map_02):
                p.x = 2111
                p.y = 635
                state = "map_02"
            warp_to_barracks1 = pygame.Rect(1023, 213, 56, 64)
            if p.get_rect().colliderect(warp_to_barracks1):
                p.x = 1281
                p.y = 303
                state = "map_04"
            warp_to_barracks2 = pygame.Rect(1274, 212, 60, 51)
            if p.get_rect().colliderect(warp_to_barracks2):
                p.x = 734
                p.y = 237
                state = "map_04"
            warp_to_barracks3 = pygame.Rect(1609, 210, 57, 53)
            if p.get_rect().colliderect(warp_to_barracks3):
                p.x = 172
                p.y = 281
                state = "map_04"
            warp_to_church_outpost = pygame.Rect(2572, 636, 36, 181)
            if p.get_rect().colliderect(warp_to_church_outpost):
                p.x = 49
                p.y = 421
                state = "map_05"
            keys = pygame.key.get_pressed()
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_inner_military1 = pygame.Rect(1268, 91, 61, 77)
            if p.get_rect().colliderect(warp_to_inner_military1):
                p.x = 1028
                p.y = 393
                state = "map_03"
            warp_to_inner_military2 = pygame.Rect(718, 89, 73, 78)
            if p.get_rect().colliderect(warp_to_inner_military2):
                p.x = 1276
                p.y = 422
                state = "map_03"
            warp_to_inner_military3 = pygame.Rect(170, 168, 60, 30)
            if p.get_rect().colliderect(warp_to_inner_military3):
                p.x = 1619
                p.y = 413
                state = "map_03"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_church_outpost2 = pygame.Rect(606, 80, 77, 54)
            if p.get_rect().colliderect(warp_to_church_outpost2):
                p.x = 618
                p.y = 506
                state = "map_05"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_walled = pygame.Rect(798, 1210, 762, 11)
            if p.get_rect().colliderect(warp_to_walled):
                p.x = 80
                p.y = 600
                state = "map_02"
            warp_to_administrative_wing = pygame.Rect(2, 549, 33, 122)
            if p.get_rect().colliderect(warp_to_administrative_wing):
                p.x = 578
                p.y = 585
                state = "map_08"
            warp_to_main_cathedral = pygame.Rect(1084, 107, 177, 22)
            if p.get_rect().colliderect(warp_to_main_cathedral):
                p.x = 637
                p.y = 649
                state = "map_09"
            warp_to_home_village1 = pygame.Rect(2301, 553, 51, 115)
            if p.get_rect().colliderect(warp_to_home_village1):
                p.x = 53
                p.y = 645
                state = "map_11"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_theocratic_capital3 = pygame.Rect(559, 642, 85, 31)
            if p.get_rect().colliderect(warp_to_theocratic_capital3):
                p.x = 101
                p.y = 579
                state = "map_07"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_theocratic_capital4 = pygame.Rect(626, 725, 82, 20)
            if p.get_rect().colliderect(warp_to_theocratic_capital4):
                p.x = 1154
                p.y = 168
                state = "map_07"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_chiefs_office = pygame.Rect(2034, 364, 58, 56)
            if p.get_rect().colliderect(warp_to_chiefs_office):
                p.x = 622
                p.y = 372
                state = "map_12"
            warp_to_headmaster_office = pygame.Rect(932, 327, 57, 52)
            if p.get_rect().colliderect(warp_to_headmaster_office):
                p.x = 518
                p.y = 98
                state = "map_13"
            warp_to_home_village_center1= pygame.Rect(189, -2, 177, 26)
            if p.get_rect().colliderect(warp_to_home_village_center1):
                p.x = 49
                p.y = 440
                state = "map_14"
            warp_to_old_orphanage2 = pygame.Rect(143, 1165, 247, 22)
            if p.get_rect().colliderect(warp_to_old_orphanage2):
                p.x = 1008
                p.y = 777
                state = "map_15"
            warp_to_village_market1 = pygame.Rect(2347, 549, 23, 171)
            if p.get_rect().colliderect(warp_to_village_market1):
                p.x = 42
                p.y = 513
                state = "map_17"
            warp_to_capitalagain = pygame.Rect(-6, 632, 42, 102)
            if p.get_rect().colliderect(warp_to_capitalagain):
                p.x = 2200
                p.y = 589
                state = "map_07"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_home_village_entry3 = pygame.Rect(564, 456, 117, 20)
            if p.get_rect().colliderect(warp_to_home_village_entry3):
                p.x = 2035
                p.y = 477
                state = "map_11"
            keys = pygame.key.get_pressed()
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_home_village_entry4 = pygame.Rect(491, 6, 82, 44)
            if p.get_rect().colliderect(warp_to_home_village_entry4):
                p.x = 944
                p.y = 466
                state = "map_11"
            keys = pygame.key.get_pressed()
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_old_orphanage1 = pygame.Rect(108, 814, 99, 26)
            if p.get_rect().colliderect(warp_to_old_orphanage1):
                p.x = 654
                p.y = 56
                state = "map_15"
            warp_to_home_village_entry2 = pygame.Rect(1060, 920, 238, 34)
            if p.get_rect().colliderect(warp_to_home_village_entry2):
                p.x = 236
                p.y = 144
                state = "map_11"
            warp_to_ext_chiefs_home= pygame.Rect(1432, 449, 41, 75)
            if p.get_rect().colliderect(warp_to_ext_chiefs_home):
                p.x = 81
                p.y = 835
                state = "map_20"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_home_village_center2 = pygame.Rect(607, 3, 207, 21)
            if p.get_rect().colliderect(warp_to_home_village_center2):
                p.x = 128
                p.y = 735
                state = "map_14"
            warp_to_home_village_entry1= pygame.Rect(1121, 928, 169, 13)
            if p.get_rect().colliderect(warp_to_home_village_entry1):
                p.x = 295
                p.y = 996
                state = "map_11"
            warp_to_play_room = pygame.Rect(1143, 394, 63, 60)
            if p.get_rect().colliderect(warp_to_play_room):
                p.x = 620
                p.y = 112
                state = "map_16"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_old_orphanage2 = pygame.Rect(607, 6, 94, 67)
            if p.get_rect().colliderect(warp_to_old_orphanage2):
                p.x = 1166
                p.y = 513
                state = "map_15"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_chiefs_office = pygame.Rect(419, -1, 103, 49)
            if p.get_rect().colliderect(warp_to_chiefs_office):
                p.x = 890
                p.y = 930
                state = "map_20"
            warp_to_port1 = pygame.Rect(1805, 168, 15, 127)
            if p.get_rect().colliderect(warp_to_port1):
                p.x = 1248
                p.y = 1442
                state = "map_29"
            warp_to_port2 = pygame.Rect(1805, 168, 15, 127)
            if p.get_rect().colliderect(warp_to_port2):
                p.x = 1248
                p.y = 1442
                state = "map_29"
            warp_to_deep_terror = pygame.Rect(417, 984, 99, 30)
            if p.get_rect().colliderect(warp_to_deep_terror):
                p.x = 77
                p.y = 587
                state = "map_18"
            home_village_entry5 = pygame.Rect(1, 485, 23, 87)
            if p.get_rect().colliderect(home_village_entry5):
                p.x = 2243
                p.y = 605
                state = "map_11"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_village_market2 = pygame.Rect(-4, 578, 30, 121)
            if p.get_rect().colliderect(warp_to_village_market2):
                p.x = 441
                p.y = 910
                state = "map_17"
            warp_to_anomaly = pygame.Rect(1790, 584, 20, 138)
            if p.get_rect().colliderect(warp_to_anomaly):
                p.x = 1384
                p.y = 70
                state = "map_19"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_deepagain = pygame.Rect(1352, -6, 109, 21)
            if p.get_rect().colliderect(warp_to_deepagain):
                p.x = 1279
                p.y = 637
                state = "map_18"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_village_market3 = pygame.Rect(830, 987, 173, 30)
            if p.get_rect().colliderect(warp_to_village_market3):
                p.x = 447
                p.y = 88
                state = "map_17"
            warp_to_home_village_center3 = pygame.Rect(-6, 746, 17, 129)
            if p.get_rect().colliderect(warp_to_home_village_center3):
                p.x = 1258
                p.y = 436
                state = "map_14"
            warp_to_int_chiefs_home1 = pygame.Rect(876, 640, 68, 59)
            if p.get_rect().colliderect(warp_to_int_chiefs_home1):
                p.x = 338
                p.y = 474
                state = "map_21"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_out_chief_home = pygame.Rect(296, 543, 126, 17)
            if p.get_rect().colliderect(warp_to_out_chief_home):
                p.x = 890
                p.y = 748
                state = "map_20"
            warp_to_tribe_tunnel1 = pygame.Rect(818, 161, 87, 89)
            if p.get_rect().colliderect(warp_to_tribe_tunnel1):
                p.x = 42
                p.y = 320
                state = "map_22"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_int_chiefs_home2 = pygame.Rect(-9, 280, 29, 101)
            if p.get_rect().colliderect(warp_to_int_chiefs_home2):
                p.x = 855
                p.y = 272
                state = "map_21"
            warp_to_tribe_parameter1 = pygame.Rect(1166, 268, 39, 133)
            if p.get_rect().colliderect(warp_to_tribe_parameter1):
                p.x = 993
                p.y = 452
                state = "map_23"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_tribe_tunnel2 = pygame.Rect(976, 507, 115, 41)
            if p.get_rect().colliderect(warp_to_tribe_tunnel2):
                p.x = 1067
                p.y = 297
                state = "map_22"
            warp_to_tribe_settlement1 = pygame.Rect(1012, 7, 85, 61)
            if p.get_rect().colliderect(warp_to_tribe_settlement1):
                p.x = 52
                p.y = 617
                state = "map_24"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_tribe_parameter2 = pygame.Rect(-2, 613, 27, 98)
            if p.get_rect().colliderect(warp_to_tribe_parameter2):
                p.x = 1023
                p.y = 162
                state = "map_23"
            warp_to_healing_hut = pygame.Rect(1047, 332, 58, 50)
            if p.get_rect().colliderect(warp_to_healing_hut):
                p.x = 373
                p.y = 535
                state = "map_25"
            warp_to_storage1 = pygame.Rect(1497, 341, 120, 57)
            if p.get_rect().colliderect(warp_to_storage1):
                p.x = 823
                p.y = 254
                state = "map_26"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_tribe_settlement2 = pygame.Rect(320, 610, 177, 56)
            if p.get_rect().colliderect(warp_to_tribe_settlement2):
                p.x = 1048
                p.y = 433
                state = "map_24"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_tribe_settlement3 = pygame.Rect(778, 157, 63, 43)
            if p.get_rect().colliderect(warp_to_tribe_settlement3):
                p.x = 1426
                p.y = 491
                state = "map_24"
            warp_to_escape_route1 = pygame.Rect(1609, 330, 101, 218)
            if p.get_rect().colliderect(warp_to_escape_route1):
                p.x = 42
                p.y = 170
                state = "map_27"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_storage2 = pygame.Rect(1, 159, 12, 85)
            if p.get_rect().colliderect(warp_to_storage2):
                p.x = 1559
                p.y = 449
                state = "map_26"
            warp_to_frontier1 = pygame.Rect(1655, 255, 62, 281)
            if p.get_rect().colliderect(warp_to_frontier1):
                p.x = 42
                p.y = 722
                state = "map_28"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_storage2 = pygame.Rect(-3, 716, 24, 91)
            if p.get_rect().colliderect(warp_to_storage2):
                p.x = 1584
                p.y = 385
                state = "map_27"
            warp_to_port3 = pygame.Rect(2860, 1012, 25, 191)
            if p.get_rect().colliderect(warp_to_port3):
                p.x = 448
                p.y = 1424
                state = "map_29"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_frontier2 = pygame.Rect(394, 1480, 139, 42)
            if p.get_rect().colliderect(warp_to_frontier2):
                p.x = 2693
                p.y = 1145
                state = "map_28"
            warp_to_village_market4 = pygame.Rect(1220, 1497, 99, 31)
            if p.get_rect().colliderect(warp_to_village_market4):
                p.x = 1724
                p.y = 512
                state = "map_17"
            warp_to_customs = pygame.Rect(1833, 524, 75, 51)
            if p.get_rect().colliderect(warp_to_customs):
                p.x = 401
                p.y = 171
                state = "map_30"
            warp_to_clearance = pygame.Rect(2216, 593, 69, 57)
            if p.get_rect().colliderect(warp_to_clearance):
                p.x = 61
                p.y = 591
                state = "map_31"
            warp_to_merchant_quarter1 = pygame.Rect(2657, 1173, 22, 259)
            if p.get_rect().colliderect(warp_to_merchant_quarter1):
                p.x = 514
                p.y = 86
                state = "map_32"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_port4 = pygame.Rect(308, 0, 175, 55)
            if p.get_rect().colliderect(warp_to_port4):
                p.x = 1859
                p.y = 652
                state = "map_29"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_port5 = pygame.Rect(35, 678, 109, 33)
            if p.get_rect().colliderect(warp_to_port5):
                p.x = 2241
                p.y = 731
                state = "map_29"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_port6 = pygame.Rect(402, -3, 204, 43)
            if p.get_rect().colliderect(warp_to_port6):
                p.x = 2559
                p.y = 1232
                state = "map_29"
            warp_to_guildhall = pygame.Rect(1070, 224, 82, 88)
            if p.get_rect().colliderect(warp_to_guildhall):
                p.x = 817
                p.y = 780
                state = "map_33"
            warp_to_grillbys = pygame.Rect(2046, 527, 48, 56)
            if p.get_rect().colliderect(warp_to_grillbys):
                p.x = 934
                p.y = 764
                state = "map_34"
            warp_to_ship = pygame.Rect(1523, 1210, 113, 31)
            if p.get_rect().colliderect(warp_to_ship):
                p.x = 1290
                p.y = 742
                state = "map_35"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_merchant_quarter2 = pygame.Rect(772, 861, 122, 44)
            if p.get_rect().colliderect(warp_to_merchant_quarter2):
                p.x = 1087
                p.y = 360
                state = "map_32"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_merchant_quarter3 = pygame.Rect(889, 838, 141, 19)
            if p.get_rect().colliderect(warp_to_merchant_quarter3):
                p.x = 2054
                p.y = 634
                state = "map_32"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_lowerdeck = pygame.Rect(764, 623, 65, 76)
            if p.get_rect().colliderect(warp_to_lowerdeck):
                p.x = 1044
                p.y = 56
                state = "map_36"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_upperrdeck = pygame.Rect(990, 2, 166, 17)
            if p.get_rect().colliderect(warp_to_upperrdeck):
                p.x = 766
                p.y = 540
                state = "map_35"
            warp_to_coastal = pygame.Rect(1310, 630, 60, 37)
            if p.get_rect().colliderect(warp_to_coastal):
                p.x = 541
                p.y = 573
                state = "map_37"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_cultvillage1 = pygame.Rect(1833, 537, 50, 151)
            if p.get_rect().colliderect(warp_to_cultvillage1):
                p.x = 138
                p.y = 1437
                state = "map_38"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_coastalback = pygame.Rect(-2, 1460, 96, 227)
            if p.get_rect().colliderect(warp_to_coastalback):
                p.x = 1728
                p.y = 603
                state = "map_37"
            warp_to_inner_sanctum = pygame.Rect(2944, 769, 53, 208)
            if p.get_rect().colliderect(warp_to_inner_sanctum):
                p.x = 918
                p.y = 923
                state = "map_40"
            warp_to_encounter = pygame.Rect(2444, 1617, 202, 62)
            if p.get_rect().colliderect(warp_to_encounter):
                p.x = 100
                p.y = 485
                state = "map_39"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_cultvillage2 = pygame.Rect(0, 410, 41, 198)
            if p.get_rect().colliderect(warp_to_cultvillage2):
                p.x = 2534
                p.y = 1413
                state = "map_38"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_cultvillage3 = pygame.Rect(888, 1008, 102, 39)
            if p.get_rect().colliderect(warp_to_cultvillage3):
                p.x = 2830
                p.y = 832
                state = "map_38"
            warp_to_cultfortress = pygame.Rect(903, 89, 70, 51)
            if p.get_rect().colliderect(warp_to_cultfortress):
                p.x = 75
                p.y = 508
                state = "map_41"
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            warp_to_backinnersanc = pygame.Rect(-6, 447, 41, 158)
            if p.get_rect().colliderect(warp_to_backinnersanc):
                p.x = 917
                p.y = 174
                state = "map_40"
            warp_to_battle1 = pygame.Rect(1120, 1005, 196, 43)
            if p.get_rect().colliderect(warp_to_battle1):
                p.x = 80
                p.y = 512
                state = "map_42"
            #warp_to_battle2 = pygame.Rect(1120, 1005, 196, 43)
            #if p.get_rect().colliderect(warp_to_battle2):
                #p.x = 80
                #p.y = 512
                #state = "map_43"
            ...
            walls = area_walls.get(state, area_walls.get("l_i_merchant_tavern", [])).copy() if area_walls.get(
                state) else area_walls["l_i_merchant_tavern"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            screen.blit(_scaled_images.get("f_o_residential_area", _scaled_images["l_i_merchant_tavern"]),
                        (-world_x, -world_y))
            walls = area_walls["map_46"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            screen.blit(_scaled_images.get("l_o_destroy_theocracy", _scaled_images["l_i_merchant_tavern"]),
                        (-world_x, -world_y))
            walls = area_walls["map_47"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            screen.blit(_scaled_images.get("l_i_orphanage_access", _scaled_images["l_i_merchant_tavern"]),
                        (-world_x, -world_y))
            walls = area_walls["map_48"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            screen.blit(_scaled_images.get("l_i_active_laboratory_under_administrative_wing",
                                           _scaled_images["l_i_merchant_tavern"]), (-world_x, -world_y))
            walls = area_walls["map_49"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            screen.blit(
                _scaled_images.get("l_i_lab_office_under_administrative_wing", _scaled_images["l_i_merchant_tavern"]),
                (-world_x, -world_y))
            walls = area_walls["map_50"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            screen.blit(_scaled_images.get("l_i_old_laboratory", _scaled_images["l_i_merchant_tavern"]),
                        (-world_x, -world_y))
            walls = area_walls["map_51"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            # SLOWED MOVEMENT MAP — Subterranean Labyrinth
            screen.blit(_scaled_images.get("l_i_subterranean_labyrinth", _scaled_images["l_i_merchant_tavern"]),
                        (-world_x, -world_y))
            walls = area_walls["map_52"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                # Halve velocity for slowed movement in the labyrinth
                _saved_speed = p.speed if hasattr(p, "speed") else None
                if hasattr(p, "speed"):
            ...
            world_y = p.y - screen_y // 2 + p.size // 2
            p.draw(screen, world_x, world_y)
            # Slowed movement HUD warning
            _lab_font = pygame.font.SysFont("Times New Roman", 18)
            _lab_surf = _lab_font.render("[ SLOWED — Subterranean Labyrinth ]", True, (180, 120, 255))
            screen.blit(_lab_surf, (screen_x // 2 - _lab_surf.get_width() // 2, screen_y - 40))
            keys = pygame.key.get_pressed()
            ...
            screen.blit(_scaled_images.get("l_i_subterranean_labyrinth_exit", _scaled_images["l_i_merchant_tavern"]),
                        (-world_x, -world_y))
            walls = area_walls["map_53"].copy()
            entity_walls = get_entity_walls(npcs, p)
            while logic_accumulator >= 1.0 / logic_tick:
                p.update_input()
                if devkit.apply_noclip():
            ...
            if user_item_book_of_crafsmanship > 0:
                ...
                tuple_static_text(user_item_book_of_crafsmanship, color=(240, 240, 240), position=(470 + 72, 93 + 30),
                                  size=15)
            ...
            if user_item_red_gem > 0:
                screen.blit(_scaled_images["user_item_red_gem"], (777, 100))
            ...
            if user_item_blue_gem > 0:
                screen.blit(_scaled_images["user_item_blue_gem"], (777, 157))
                ...
                if inv22.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            ...
                            user_mind_state += 10
            if user_item_ale > 0:
                screen.blit(_scaled_images["user_item_ale"], (777, 203))
                ...
                if inv23.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            ...
                            user_item_ale -= 1
            if user_item_wine > 0:
                screen.blit(_scaled_images["user_item_wine"], (777, 262))
                ...
                if inv24.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            ...
                            user_item_wine -= 1
            if user_item_rum > 0:
                screen.blit(_scaled_images["user_item_rum"], (777, 317))
            ...
            if user_item_iron_ingot > 0:
                screen.blit(_scaled_images["user_item_iron_ingot"], (777, 370))
            ...
            if user_item_raw_iron > 0:
                screen.blit(_scaled_images["user_item_raw_iron"], (777, 435))
            ...
            if user_item_green_herb > 0:
                screen.blit(_scaled_images["user_item_green_herb"], (777, 465))
            ...
            if user_item_blue_herb > 0:
                screen.blit(_scaled_images["user_item_blue_herb-1"], (777, 519))
            ...
            if user_item_paper > 0:
                screen.blit(_scaled_images["user_item_paper"], (777, 574))
            ...
            if user_item_ancient_paper > 0:
                screen.blit(_scaled_images["user_item_ancient_paper"], (928, 102))
            ...
            if user_item_antibiotics > 0:
                screen.blit(_scaled_images["user_item_antibiotics"], (928, 160))
            ...
            if user_item_betadine > 0:
                screen.blit(_scaled_images["user_item_betadine"], (928, 216))
            ...
            if user_item_red_vial > 0:
                screen.blit(_scaled_images["user_item_red_vial"], (928, 256))
            ...
            if user_item_empty_vial > 0:
                screen.blit(_scaled_images["user_item_empty_vial"], (928, 311))
            ...
            if user_item_book_of_marksmanship > 0:
                ...
                tuple_static_text(user_item_book_of_marksmanship, color=(240, 240, 240), position=(911 + 72, 353 + 30),
                                  size=15)
            ...
            if user_item_book_of_rapid_fire > 0:
                ...
                tuple_static_text(user_item_book_of_rapid_fire, color=(240, 240, 240), position=(911 + 72, 405 + 30),
                                  size=15)
            ...
            if user_item_leather_scraps > 0:
                screen.blit(_scaled_images["user_item_leather_scraps"], (922, 465))
            ...
            if user_item_wooden_plank > 0:
                screen.blit(_scaled_images["user_item_wooden_plank"], (934, 530))
            ...
            if user_item_silver_wire > 0:
                screen.blit(_scaled_images["user_item_silver_wire"], (936, 570))
            ...
            if user_item_bowstring > 0:
                screen.blit(_scaled_images["user_item_bow_string"], (1049, 93))
            ...
            if user_item_red_amulet > 0:
                screen.blit(_scaled_images["user_item_red_amulet"], (1058, 217))
                ...
                if inv43.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            user_mind_state_resistance = 3
            if user_item_arm_guard > 0:
                screen.blit(_scaled_images["user_item_arm_guard"], (1060, 255))
                ...
                if inv44.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            user_def = 13
            if user_item_ring > 0:
                screen.blit(_scaled_images["user_item_ring"], (1076, 307))
                tuple_static_text(user_item_ring, color=(240, 240, 240), position=(1050 + 72, 303 + 30), size=15)
                if inv45.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            user_def = 1
            if user_item_wind_essence > 0:
                screen.blit(_scaled_images["user_item_blue_amulet"], (1049, 455))
                tuple_static_text(user_item_wind_essence, color=(240, 240, 240), position=(1049 + 72, 455 + 30), size=15)
                if inv46.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            print('1')
            if user_item_musket > 0:
                screen.blit(_scaled_images["user_item_musket"], (1050, 400))
            ...
            if user_item_swift_boots > 0:
                screen.blit(_scaled_images["user_item_swift_boots"], (1053, 508))
            ...
            if user_item_black_dressed_doll > 0:
                screen.blit(_scaled_images["user_item_black_dressed_doll"], (1049, 558))
                tuple_static_text(user_item_black_dressed_doll, color=(240, 240, 240), position=(1049 + 72, 558 + 30),
                                  size=15)
            ...
            if user_item_stick > 0:
                screen.blit(_scaled_images["user_item_stick"], (470, 93))
            ...
            if user_item_iron_helmet > 0:
                screen.blit(_scaled_images["user_item_iron_helmet"], (479, 208))
            ...
            if user_item_cloth_hood > 0:
                screen.blit(_scaled_images["user_item_cloth_hood"], (472, 248))
            ...
            if user_item_chainmail_hood > 0:
                screen.blit(_scaled_images["user_item_chainmail_hood"], (471, 353))
            ...
            if user_item_plate_helmet > 0:
                screen.blit(_scaled_images["user_item_plate_helmet"], (470, 405))
            ...
            if user_item_iron_mask > 0:
                screen.blit(_scaled_images["user_item_iron_mask"], (470, 458))
            ...
            if user_item_guard_bascinet > 0:
                screen.blit(_scaled_images["user_item_guard_bascinet"], (468, 508))
            ...
            if user_item_red_scarf > 0:
                screen.blit(_scaled_images["user_item_red_scarf"], (467, 560))
            ...
            if user_item_leather_vest > 0:
                screen.blit(_scaled_images["user_item_leather_vest"], (613, 93))
            ...
            if user_item_loincloth > 0:
                screen.blit(_scaled_images["user_item_loincloth"], (614, 143))
            ...
            if user_item_priests_robe > 0:
                screen.blit(_scaled_images["user_item_priests_robe"], (619, 194))
            ...
            if user_item_dark_priests_robe > 0:
                screen.blit(_scaled_images["user_item_dark_priests_robe"], (616, 249))
            ...
            if user_item_hard_leather_armor > 0:
                screen.blit(_scaled_images["user_item_hard_leather_armor"], (616, 299))
            ...
            if user_item_plated_mail > 0:
                screen.blit(_scaled_images["user_item_plated_mail"], (617, 354))
            ...
            if user_item_black_dress > 0:
                screen.blit(_scaled_images["user_item_black_dress"], (615, 404))
            ...
            if user_item_iron_cuirass > 0:
                screen.blit(_scaled_images["user_item_iron_cuirass"], (614, 458))
            ...
            if user_item_trench_coat > 0:
                screen.blit(_scaled_images["user_item_trench_coat"], (618, 561))
            ...
            if user_item_wooden_buckler > 0:
                screen.blit(_scaled_images["user_item_wooden_buckler"], (777, 100))
            ...
            if user_item_scutum > 0:
                screen.blit(_scaled_images["user_item_scutum"], (777, 157))
            ...
            if user_item_short_sword > 0:
                screen.blit(_scaled_images["user_item_short_sword"], (777, 262))
            ...
            if user_item_cleaver > 0:
                screen.blit(_scaled_images["user_item_cleaver"], (777, 317))
            ...
            if user_item_dagger > 0:
                screen.blit(_scaled_images["user_item_dagger"], (777, 370))
            ...
            if user_item_longsword > 0:
                screen.blit(_scaled_images["user_item_longsword"], (777, 435))
            ...
            if user_item_iron_axe > 0:
                screen.blit(_scaled_images["user_item_iron_axe"], (777, 465))
            ...
            if user_item_corsairs_saber > 0:
                screen.blit(_scaled_images["user_item_corsairs_saber"], (777, 574))
            ...
            if user_item_knife > 0:
                screen.blit(_scaled_images["user_item_knife"], (928, 102))
            ...
            if user_item_improvised_shiv > 0:
                screen.blit(_scaled_images["user_item_improvised_shiv"], (928, 160))
            ...
            if user_item_steel_hammer > 0:
                screen.blit(_scaled_images["user_item_steel_hammer"], (928, 216))
            ...
            if user_item_stiletto > 0:
                screen.blit(_scaled_images["user_item_stiletto"], (928, 256))
                ...
                if inv34.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            print('1')
            if user_item_dirk > 0:
                screen.blit(_scaled_images["user_item_dirk"], (928, 311))
            ...
            if user_item_scimitar > 0:
                screen.blit(_scaled_images["user_item_scimitar"], (911, 353))
            ...
            if user_item_greatsword > 0:
                screen.blit(_scaled_images["user_item_greatsword"], (911, 405))
            ...
            if user_item_makeshift_spear > 0:
                screen.blit(_scaled_images["user_item_makeshift_spear"], (922, 465))
                ...
                if inv38.collidepoint(mouse_x, mouse_y):
                    for event in events:
                        if event.type == pygame.MOUSEBUTTONDOWN:
                            print('1')
            if user_item_maul > 0:
                screen.blit(_scaled_images["user_item_maul"], (934, 530))
            ...
            if user_item_claymore > 0:
                screen.blit(_scaled_images["user_item_claymore"], (936, 570))
            ...
            if user_item_spear > 0:
                screen.blit(_scaled_images["user_item_spear"], (1049, 93))
            ...
            if user_item_short_bow > 0:
                screen.blit(_scaled_images["user_item_short_bow"], (1068, 164))
            ...
            if user_item_longbow > 0:
                screen.blit(_scaled_images["user_item_longbow"], (1053, 195))
            ...
            if user_item_blunderbuss > 0:
                screen.blit(_scaled_images["user_item_blunderbuss"], (1050, 248))
            ...
            if user_item_heavy_crossbow > 0:
                screen.blit(_scaled_images["user_item_heavy_crossbow"], (1050, 303))
            ...
            if user_item_flintlock > 0:
                screen.blit(_scaled_images["user_item_flintlock"], (1051, 352))
            ...
            if inv_next.collidepoint(mouse_x, mouse_y):
                for event in events:
                    if event.type == pygame.MOUSEBUTTONDOWN:
                        state = "inventory_bag"
        elif state == "fight_general":
            turn = 0
            rect_1 = pygame.Rect(68, 526, 185, 136)
            rect_2 = pygame.Rect(391, 527, 185, 145)
            rect_3 = pygame.Rect(724, 533, 164, 135)
            rect_4 = pygame.Rect(1020, 527, 180, 145)
            enemy = random.randint(1, 1)
            if enemy == 1:
                e_hp = random.randint(20, 130)
                e_str = random.randint(1, 50)
                e_agi = random.randint(1, 30)
                e_def = random.randint(1, 50)
            while True:
                now = time.time()
                delta = now - last_time
                last_time = now
                ...
                if enemy == "01":
                    ...
                    screen.blit(_scaled_images["e_elucidate_mercenary_sprite_idle_2"], (250, 20))
                    if turn >= 1:
                        if rect_1.collidepoint(mouse_x, mouse_y):
                            for event in events:
                                if event.type == pygame.MOUSEBUTTONDOWN:
                                    print("")
                    ...
                    enemy = "01"
                static_text_raw(user_class, color=(255, 255, 255), position=(470+190, 5+50), size=30)
                static_text_raw("Name:", color=(255, 255, 255), position=(360+270, 35+50), size=30)
                static_text_raw(user_name, color=(255, 255, 255), position=(470+270, 35+50), size=30)
                static_text_raw("Body ", color=(255, 255, 255), position=(360+270, 130+50), size=20)
                static_text_raw(str(user_body), color=(255, 255, 255), position=(430+270, 130+50), size=20)
                static_text_raw("STR ", color=(255, 255, 255), position=(360+270, 150+50), size=20)
                static_text_raw(str(user_str), color=(255, 255, 255), position=(430+270, 150+50), size=20)
                static_text_raw("DEF ", color=(255, 255, 255), position=(360+270, 170+50), size=20)
                static_text_raw(str(user_def), color=(255, 255, 255), position=(430+270, 170+50), size=20)
                static_text_raw("AGI ", color=(255, 255, 255), position=(360+270, 190+50), size=20)
                static_text_raw(str(user_agi), color=(255, 255, 255), position=(430+270, 190+50), size=20)
                static_text_raw("Mind ", color=(255, 255, 255), position=(360+270, 210+50), size=20)
                static_text_raw(str(user_mind_state), color=(255, 255, 255), position=(430+270, 210+50), size=20)
                static_text_raw("—————————————————————————————", color=(255, 255, 255), position=(360 + 270, 230 + 50), size=20)
